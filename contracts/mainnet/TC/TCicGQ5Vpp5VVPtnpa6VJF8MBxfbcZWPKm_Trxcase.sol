//SourceUnit: trxcase.sol

 /*  TrxCase is the perfect combination of Digital Technology, High Security and Community Program
 *   Safe and decentralized. The Smart Contract source is verified and available to everyone.
 *
 *   ┌───────────────────────────────────────────────────────────────────────┐
 *   │   Website: https://trxcase.com     									 │
 * 	 │                                                                       │
 *	 │	 2% Daily ROI + 1% PERSONAL HOLD-BONUS 	
 *
 *	 │   COMMUNITY BONUS: +0.1% roi will be increases every5 will be joined Referral commission to community (Max 0.5% extra) 
 *	 │                                                                       │
 ...
 *  [TEAM BONUS]
 *    
 *    -Team Bonus on Partners Daily Income every time me they make a withdrawal
 *
 *   [AFFILIATE PROGRAM]
 *
...
contract Trxcase {
	...
	function withdraw() public {
		...
		ReInvest(msg.sender,totalAmount.mul(20).div(100));
		user.checkpoint = block.timestamp;
		...
		emit Withdrawn(msg.sender, totalAmount.mul(80).div(100));
