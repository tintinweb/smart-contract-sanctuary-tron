...
contract TokenXTY is Context, IERC20, Ownable {
    ...
    uint256 public _maxTxAmount = 8000000000*10**uint256(_decimals);//8.000.000.000 maxTX
    uint256 private constant _tTotal = 80000000000*10**uint256(_decimals);//80.000.000.000
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private constant _name = 'XTRNY';
