...
contract TronGlobal {
	...
	uint256 constant public MarketingFee = 400;
	uint256 constant public ServiceFee = 300;
	uint256[] public ReferralCommissions = [1000, 200, 100];
	...
	uint256 constant public StartBonus = 350;
	uint256 constant public ContractBonusCap = 100;
	uint256 constant public HoldBonusCap = 350;
    ...
    require(msg.sender == MarketingFeeAddress || msg.sender == ServiceFeeAddress);
