...
contract ExaadoCash is ITRC20 {
   ...
   function createProduct(string memory _name, uint _price) public {
    ...
    function purchaseProduct(uint _id) public payable {
        ...
        // Pay the seller, we will skip this as the paying proccess will not be handled by us we only need to creat a button who will trigger the event below
 ...
 * `TRC20` functions.
 */
contract Token is ExaadoCash, TRC20Detailed {

    /**
     * @dev Constructor that gives msg.sender all of existing tokens.
     */
    constructor () public TRC20Detailed("ExaadoCash", "USDT", 18) {
