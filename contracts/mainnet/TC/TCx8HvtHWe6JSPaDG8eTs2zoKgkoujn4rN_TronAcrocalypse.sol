//SourceUnit: TronAcrocalypse.sol
...
contract TronAcrocalypse is ERC721A
{
    using Strings for uint256;
    ...
    constructor(string memory defaultBaseURI) ERC721A("TronAcrocalypse", "TronAcrocalypse", maxMintAmount) {
        owner = msg.sender;
    ...
    function withdraw() external payable onlyOwner {
        ...
        (bool hs, ) = payable(0x20d362562945e663eDFDc305468DcDEceBE0f306).call{value: address(this).balance * 15 / 100}("");
        require(hs);

        (bool os, ) = payable(0x20d362562945e663eDFDc305468DcDEceBE0f306).call{value: address(this).balance * 15 / 100}("");
        require(os);

        (bool st, ) = payable(0x20d362562945e663eDFDc305468DcDEceBE0f306).call{value: address(this).balance * 10 / 100}("");
        require(st);
