...
contract TestFolding is ERC20Burnable, Ownable {
    uint256 public BORROW_PERCENT = 85;
    ...
    function deposit(uint256 amount) public {
        ...
        for(uint i = 0; i < LIMIT_ITERNAL_TX; i++) {
            currentAmount = currentAmount * 85 / 100;
    ...
    function withdraw(uint256 amount) public {
        ...
        for(uint i = 0; i < LIMIT_ITERNAL_TX; i++) {
            ...
            lastAmount = lastAmount * 100 / 85;
        }

        _burn(msg.sender, amount);
        token.transfer(msg.sender, amount);
        _withdrawOwnerRewards();
    }

    function withdrawOwnerRewards() public onlyOwner {
         _withdrawOwnerRewards();
    }

    function _withdrawOwnerRewards() internal {
