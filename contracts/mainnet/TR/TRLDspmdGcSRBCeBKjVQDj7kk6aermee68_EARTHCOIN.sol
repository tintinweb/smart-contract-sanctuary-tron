...
contract EARTHCOIN  is owned {
    ...
    string constant private _name = "EARTHCOIN";
    string constant private _symbol = "ETC";
    uint256 constant private _decimals = 8;
    uint256 private _totalSupply;
    uint256 constant public maxSupply = 10000000 * (10**_decimals);    //1 cr. tokens
    uint constant private _preMine =  10000000 * (10**_decimals);       // 1 cr. token for deployer 
