//SourceUnit: MetaDoKingToken.sol
...
contract Token is Context, ITRC20, Ownable {
    ...
    string private _name = 'MetaDoKing';
    string private _symbol = 'MetaDoKing';
    uint8 private _decimals = 6;
    uint256 private _totalSupply = 1888 * 10**uint256(_decimals);
    ...
    // ÿ���������10ö
    uint256 private maxBuy= 5 * 10**6;
    uint256 public _maxTxAmount = 5 * 10**6;

    uint256 public _maxHavAmount = 20 * 10**6;
