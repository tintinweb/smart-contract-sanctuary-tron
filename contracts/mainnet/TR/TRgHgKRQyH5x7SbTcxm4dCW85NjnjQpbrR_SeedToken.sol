...
/**
 * @title SeedToken
 * @dev SeedToken, where all tokens are pre-assigned to the creator.
 * Note you can later distribute these tokens as you wish using `transfer` and other
 * `TRC20` functions.
 */
contract SeedToken is TRC20, TRC20Detailed {

    /**
     * @dev Constructor that gives msg.sender all of existing tokens.
     */
    constructor () public TRC20Detailed("Seed", "SED", 8) {
