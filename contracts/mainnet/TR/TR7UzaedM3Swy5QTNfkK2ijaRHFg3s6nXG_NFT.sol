...
/**
 * @title Metaverse Non-Fungible Token
 * @dev Metaverse Non-Fungible Token, where all tokens are pre-assigned to the creator.
 * Note they can later distribute these tokens as they wish using `transfer` and other
 * `TRC20` functions.
 */
contract NFT is TRC20, TRC20Detailed {

    /**
     * @dev Constructor that gives msg.sender all of existing tokens.
     */
    constructor () public TRC20Detailed("Metaverse Non-Fungible Token", "M-NFT", 2) {
