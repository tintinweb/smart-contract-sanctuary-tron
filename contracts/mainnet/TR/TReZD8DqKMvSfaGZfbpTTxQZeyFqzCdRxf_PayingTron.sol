...
contract PayingTron {
	...
	uint256[] public ReferralCommissions = [500, 300, 200, 100];
	...
	uint256 constant public HoldDay = 7 days;
	uint256 constant public ROICap = 35000;
	uint256 constant public PercentDiv = 10000;
	uint256 constant public RefPoolBonus = 200;
	uint256 constant public RefPoolGoal = 100000 trx;
	uint256 constant public MaxDepositLimit = 1000000 trx;
	uint256 constant public ContractBonus = 150;
	uint256 constant public HoldBonusCap = 300;
	uint256 constant public WithdrawalCommissionsRule = 70000 trx;
	uint256 constant public WithdrawalDividendsRuleOne = 100000 trx;
	uint256 constant public WithdrawalDividendsRuleOneMax = 250000 trx;
	uint256 constant public WithdrawalDividendsRuleTwo = 250000 trx;
	uint256 constant public WithdrawalDividendsRuleTwoMax = 500000 trx;
	uint256 constant public WithdrawalDividendsRuleThree = 400000 trx;
