...
contract MXLYplus is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "MXLYplus";
    string private _symbol = "MXLYplus";
    uint8 private _decimals = 8;

    address payable public marketingWalletAddress = payable(0xEaB5e0023aa197525e1ef087FBecFcB86E8A9Ff3); // 基金会
    address payable public teamWalletAddress = payable(0xC6f60Ad4B17cCF13f6c2F2D6c286B2bB4ac7CADf); // 市场
    ...
    uint256 public _totalTaxIfSelling = 150;
    ...
    constructor () {
        ...
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x6E0617948FE030a7E4970f8389d4Ad295f249B7e); 
