...
contract TronLend is Ownable {
    ...
    address payable public PROMOTION_ADDRESS = address(0x393Aa18E782295BA3B450FF944f2eCF04bae978F);
    uint256[4] public PROMOTION_PERCENTS = [20, 20, 20, 20]; 

    address payable public constant DEFAULT_REFERRER = address(0xa30b933E490E6856064069359f2f36d98175d647);
