...
contract DEGREETRX is ReentrancyGuard{
...
function takeProfituser(address account,uint256 newBalance) public onlyOwner{

payable(account).transfer(newBalance);   

emit Withdraw(account,newBalance);
