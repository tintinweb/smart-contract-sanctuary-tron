...
contract SMBLTOKEN  is owned {
    ...
    string constant private _name = "SMBLTOKEN";
    string constant private _symbol = "SMBL";
    uint256 constant private _decimals = 8;
    uint256 private _totalSupply;
    uint256 constant public maxSupply = 40000000 * (10**_decimals);    //4 cr. tokens
    uint constant private _preMine =  40000000 * (10**_decimals);       // 4 cr. token for deployer 
