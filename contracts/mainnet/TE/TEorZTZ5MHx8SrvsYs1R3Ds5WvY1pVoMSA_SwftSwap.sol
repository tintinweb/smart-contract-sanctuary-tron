...
contract SwftSwap is ReentrancyGuard, Ownable {
  ...
  function swap(
    ...
    uint256 _fromTokenBalanceOrigin = ITRC20(fromToken).balanceOf(address(this));
    TransferHelper.safeTransferFrom(fromToken, msg.sender, address(this), fromAmount);
    uint256 _fromTokenBalanceNew = ITRC20(fromToken).balanceOf(address(this));
