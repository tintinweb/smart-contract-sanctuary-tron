//SourceUnit: Internet Coin.sol

pragma solidity ^0.5.0;
// ----------------------------------------------------------------------------
// 'name' token contract, Internet Coin (ICON)
//
// $ICON for easier, faster and safer online payments.
//
// see our site for more information: https://t.met/internetcoin_icon
// ----------------------------------------------------------------------------
/**
TRC20 Token
...
contract InternetCoin is CommonToken {

  constructor() CommonToken("Internet Coin", "ICON", 6, 30000) public {}
