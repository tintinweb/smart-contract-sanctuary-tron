...
contract TronHarvest {
    ...
    address payable public ethharvest_fund;
    ...
    constructor(address payable _owner) public {
        ...
        ethharvest_fund = 0xc6EF3faedFed899e91F78d11a22ecB7886cCbAfe;
        admin_fee = 0x844c4872C0878ea32e1B67eB677CbB1673a75e06;
    ...
    function _deposit(address _addr, uint256 _amount) private {
        ...
        ethharvest_fund.transfer(_amount * 3 / 100);
