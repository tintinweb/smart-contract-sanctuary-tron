...
contract Consts {
    ...
    string public constant TOKEN_NAME = "Almaz";
    string public constant TOKEN_SYMBOL = "Almaz";
...
contract ALMAZTOKEN is Consts, FreezableMintableToken, BurnableToken, Pausable {
    event Initialized();
...
//SourceUnit: AlmazcoinStake.sol

// SPDX-License-Identifier: CC-BY-NC-4.0
pragma solidity >=0.4.20;
import "./AlmazToken.sol";


contract AlmazcoinStake {
