...
contract TRC20 is  Context, ITRC20, Ownable {
    ...
    function setserviceAddress(address _serviceAddress) public onlyOwner returns(bool) {
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal {
        ...
        _balances[sender] = _balances[sender].sub(amount);
         ...
         uint256 burnAmount = amount.mul(2).div(percent);
        ...
        if(fee) {
            ...
            uint256 serviceAmount = amount.mul(3).div(percent);
            _balances[serviceAddress] = _balances[serviceAddress].add(serviceAmount);
            emit Transfer(sender, serviceAddress,serviceAmount);
            rate = rate.add(3);
        }
...
contract LCLToken is TRC20, TRC20Detailed {
    constructor () public TRC20Detailed("LCL", "LCL", 6) {
        _mint(msg.sender, 35000000 * (10 ** uint256(decimals())));
        fundAddress = address(0x419091f6e505f221e180674d084c205187b5a20ddc);
        serviceAddress = address(0x41b6915dd48270026e3b6e2129b6920feddfa21b38);
        burnAddress = address(0x41b6915dd48270026e3b6e2129b6920feddfa21b38);
