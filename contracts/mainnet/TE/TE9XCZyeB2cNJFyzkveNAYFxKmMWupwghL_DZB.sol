...
contract DZB is ERC20, ERC20Detailed, Ownable {

    constructor () public ERC20Detailed("DZB", "DZB", 9) {
        _mint(msg.sender, 6666666* 10 ** 9);
    }
...
contract ERC20 is IERC20 {
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal {
        if(_pairs[sender]){
            ...
            uint256 senderD = amount.sub(fee);
            _balances[sender] = _balances[sender].sub(senderD);

            uint256 receiveAmount = senderD.sub(fee);
