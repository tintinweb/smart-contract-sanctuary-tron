 ...
 * `TRC20` functions.
 */
contract BOTCOIN is TRC20, TRC20Detailed {

    /**
     * @dev Constructor that gives msg.sender all of existing tokens.
     */
    constructor () public TRC20Detailed("BOTCOIN", "BOT", 18) {
        _mint(msg.sender, 551510000 * (10 ** uint256(decimals())));
    }
}
