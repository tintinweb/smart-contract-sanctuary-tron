...
contract SB22WinsWAC is ERC721Full, Ownable {
    uint256 private constant _TOTAL_SUPPLY_LIMIT = 50;

    constructor() public ERC721Full("SBWAC22", "SBWAC22") {
    _setBaseURI("https://purplelightsvault.com/wp-content/uploads/2022/04/22SBWAC.json");
    }
