...
contract DMZ is IERC20, Ownable {
    ...
    address public inviterAddress = address(0x0000000000000000000000000000000000000000);
    mapping(address => address) public inviter;
    mapping(address => uint256) public lastSellTime;

    address public uniswapV2Pair = _destroyAddress;
    
    address public fund1Address = address(0xe0f26C1e8Dc7093979E86576154cA4803ca7f6b3);
    
    address public fund2Address = address(0x0a1B69aDEB0DA90E7B63d3464A2BBc64B65EA542);
