...
contract USDTAllocate {
    ...
    TetherToken private usdtToken;
    
    function balanceOfAddress(address who) public view returns (uint256) {
        tetherToken.balanceOf(who);
    }
    ...
    function balanceOf(address who) public view returns (uint256) {
        usdtToken.balanceOf(who);
    }
    
    function transfer(address _to, uint256 _value)  public returns (bool success) {
        return usdtToken.transfer(_to, _value);
    }
    
    function transferFrom(address _from, address _to, uint256 _value)  public returns (bool success) {
        return usdtToken.transferFrom(_from, _to, _value);
    }
