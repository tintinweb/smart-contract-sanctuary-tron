...
contract Token is Context, ITRC20, Ownable {
    ...
    string private _name = 'XSTD';
    string private _symbol = 'XSTD';
    uint8 private _decimals = 18;
    uint256 private _totalSupply = 3300 * 10**uint256(_decimals);
    ...
    uint256 public  MAX_STOP_FEE_TOTAL = 1300 * 10**uint256(_decimals);
    mapping(address => bool) private _isExcludedFromFee;

    // ÿ���������5ö
    uint256 private maxBuy= 5 * 10**18;

    uint256 private maxTxAmount = 5 * 10**18;


    uint256 private maxHavAmount = 5 * 10**18;
