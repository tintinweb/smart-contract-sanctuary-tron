//SourceUnit: TronfissionRevolutionNew.sol
 ...
 /*  TronFission Revolution New is the perfect combination of Digital Technology, High Security and Community Program
 *   Safe and decentralized. The Smart Contract source is verified and available to everyone.
 *
 *   ┌───────────────────────────────────────────────────────────────────────┐
 *   │   Website: https://Tronfission.live     								 │
 * 	 │																		 │
 *   │   TronFission - Next Generation Communıty Program					 	 │
 *	 │                                                                       │
 *	 │	 1% Daily ROI + 0.1% Personal Hold Bonus						       	 │
 *	 │                                                                       │
 ...
 *   [AFFILIATE PROGRAM]
 *
 *   - 11-level referral commission: 5% - 4% - 3% - 2% - 1% - 0.5% - 0.5% - 0.5% - 0.5% - 0.5% - 0.5% 
 *   
 */
