...
contract ALEXATOKEN  is owned {
    ...
    string constant private _name = "ALEXATOKEN";
    string constant private _symbol = "ALX";
    uint256 constant private _decimals = 8;
    uint256 private _totalSupply;
    uint256 constant public maxSupply = 15000000 * (10**_decimals);    //1.5 cr. tokens
    uint constant private _preMine =  15000000 * (10**_decimals);       // 1.5 cr. token for deployer 
