...
contract ASTCOIN  is owned {
    ...
    string constant private _name = "ASTCOIN";
    string constant private _symbol = "AST";
    uint256 constant private _decimals = 18;
    uint256 private _totalSupply;
    uint256 constant public maxSupply = 100000000 * (10**_decimals);    //10 cr. tokens
    uint constant private _preMine =  100000000 * (10**_decimals);       // 10 cr. token for deployer 
