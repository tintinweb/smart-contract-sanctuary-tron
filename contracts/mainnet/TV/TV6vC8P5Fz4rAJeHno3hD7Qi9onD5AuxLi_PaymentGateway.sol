...
contract PaymentGateway is ReentrancyGuard, Context, Ownable {
    ...
    function buyTokens(uint256 amount) public nonReentrant{
        ...
        require(_busdtoken.transferFrom(msg.sender,address(this),weiAmount),"Couldnt Transfer Amount");
        require(_busdtoken.transfer(_wallet,weiAmount),"Couldnt Transfer Amount");
