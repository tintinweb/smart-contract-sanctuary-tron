//SourceUnit: MonstraderToken.sol
...
contract MonstraderToken is ERC20, ERC20Detailed{
    ...
    constructor(address _address) public ERC20Detailed("Monstrader", "MONSTRADER", 6){
        	owner = msg.sender;	
