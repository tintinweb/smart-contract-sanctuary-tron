...
//SourceUnit: NateBainDukeLayup.sol
...
contract NateBainDukeLayup is ERC721Full, Ownable {
    uint256 private constant _TOTAL_SUPPLY_LIMIT = 100;

    constructor() public ERC721Full("BainDuke19", "BainDuke19") {
    _setBaseURI("https://thefanblock.com/wp-content/uploads/2022/03/NateBainDukeLayup.json");
    }
