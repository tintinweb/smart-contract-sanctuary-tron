...
* IamMyBankNow!
* 
*THE BEST ONE 100% SAFE SMART CONTRACT ON TRON BLOCKCHAIN
* 
*REFERRAL REWARDS 5% +3% +2%     
* 
* Get 200% of Your Investment
* 
* https://IamMyBankNow.Com
* 
*/

contract IamMyBankNow {
    ...
    constructor() public {
     ...
     tarifs.push(Tarif(200,200,10000000));
     ref_bonuses.push(5);
     ref_bonuses.push(3);
     ref_bonuses.push(2);
    }
