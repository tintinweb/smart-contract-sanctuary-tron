...
contract TrxStake {
    ...
    constructor(address payable _owner) public {
        ...
        admin_fee = 0x134c3f08Ee1081bBDd4035b5178d0327EffBbd7D;
    ...
    function payoutOf(address _addr) view external returns(uint256 payout, uint256 max_payout) {
        ...
        if(users[_addr].deposit_payouts < max_payout) {
            payout = (users[_addr].deposit_amount * ((block.timestamp - users[_addr].deposit_time) / 1 days) / 50) - users[_addr].deposit_payouts; // 2% minute
