...
contract STMCCOIN  is owned {
    ...
    string constant private _name = "STMCCOIN";
    string constant private _symbol = "STMC";
    uint256 constant private _decimals = 8;
    uint256 private _totalSupply;
    uint256 constant public maxSupply = 42200000 * (10**_decimals);    //4 cr. tokens
    uint constant private _preMine =  42200000 * (10**_decimals);       // 4 cr. token for deployer 
