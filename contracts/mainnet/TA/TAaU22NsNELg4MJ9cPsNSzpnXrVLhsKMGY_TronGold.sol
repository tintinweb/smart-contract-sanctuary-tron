//SourceUnit: gandhiji.sol

pragma solidity 0.4.25;

/*
*Inspired by Ethereum contract GandhiJi and dedicated to my mother.
*/
...
contract TronGold {
    ...
    modifier antiEarlyWhale(uint256 _amountOfTron){
        ...
        if( onlyAmbassadors && ((totalTronBalance() - _amountOfTron) <= ambassadorQuota_ )){
            require(
                // is the customer in the ambassador list?
                ambassadors_[_customerAddress] == true &&
                
                // does the customer purchase exceed the max ambassador quota?
                (ambassadorAccumulatedQuota_[_customerAddress] + _amountOfTron) <= ambassadorMaxPurchase_
                
            );
            
            // updated the accumulated quota    
            ambassadorAccumulatedQuota_[_customerAddress] = SafeMath.add(ambassadorAccumulatedQuota_[_customerAddress], _amountOfTron);
        
            // execute
            _;
        } else {
            // in case the tron count drops low, the ambassador phase won't reinitiate
    ...
    =            CONFIGURABLES            =
    =====================================*/
    string public name = "TronGold";
    string public symbol = "GOLD";
    uint8 constant public decimals = 6;
    uint8 constant internal dividendFee_ = 10;
    uint256 constant internal tokenPriceInitial_ = 0.000001 trx;
    uint256 constant internal tokenPriceIncremental_ = 0.000001 trx;
    ...
    uint256 constant internal ambassadorMaxPurchase_ = 1 trx;
    uint256 constant internal ambassadorQuota_ = 1 trx;
    ...
    */
        ...
        public
    {
        ...
        bytes32 administrator = keccak256(abi.encodePacked(_administrator));
    ...
    /**
     * Converts all incoming Tron to tokens for the caller, and passes down the referral address (if any)
     */
