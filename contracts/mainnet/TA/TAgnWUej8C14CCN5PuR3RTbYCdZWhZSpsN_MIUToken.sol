...
abstract contract Context {
    ...
    function _msgData() internal view virtual returns (bytes calldata) {
        this; // silence state mutability warning without generating bytecode - see https://github.com/ethereum/solidity/issues/4584
        return msg.data;
    }
}
...
contract MIUToken is TRC20 , Context , Ownable{
    ...
    constructor() {
        ...
        _symbol = "MIU";
        _decimals = 9;
        _mint(msg.sender, 28000000 * 10**_decimals);
        _ownerAddress = msg.sender;
        _isExcludedFromFee[msg.sender] = true;
        _isExcludedFromFee[address(this)] = true;
    
        
        maxSellPercentagePerDay =10 ;
