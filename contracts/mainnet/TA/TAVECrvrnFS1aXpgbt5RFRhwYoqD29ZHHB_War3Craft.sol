...
contract TRC721MetadataMintable is TRC721, TRC721Metadata, MinterRole {
    ...
    function mintWithTokenURI(address to, uint256 tokenId, string memory tokenURI) public onlyMinter returns (bool) {
        require(tokenId > 0 && tokenId < 2031, "Invalid token id");
        _mint(to, tokenId);
...
contract War3Craft is TRC721, TRC721Enumerable, TRC721MetadataMintable {
    constructor() public TRC721Metadata("War3Craft", "War3Craft") {
