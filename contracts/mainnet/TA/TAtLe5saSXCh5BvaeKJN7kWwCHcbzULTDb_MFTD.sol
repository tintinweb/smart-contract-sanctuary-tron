...
contract _MFTD is ERC20, ERC20Detailed, ERC20Burnable {
    constructor() ERC20Detailed('TS9_MFTD', 'MFTD', 18)  {
...
contract MFTD is Ownable,_MFTD{
      using SafeMath for uint256;
...
function sendMultiTron(address payable[]  memory  _contributors, uint256[] memory _balances) public  payable  {
