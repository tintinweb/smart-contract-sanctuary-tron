...
contract Token is Context, ITRC20, Ownable {
    ...
    uint256 public  MAX_STOP_FEE_TOTAL = 58 * 10**uint256(_decimals);
    mapping(address => bool) private _isExcludedFromFee;

    // ÿ���������10ö
    uint256 private maxBuy= 100 * 10**6;

    uint256 private maxTxAmount = 100 * 10**6;


    uint256 private maxHavAmount = 100 * 10**6;
