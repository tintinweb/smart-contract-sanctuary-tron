...
contract Token is Context, IERC20, Ownable {
    ...
    uint256 private  _tTotal = 9588 * 10**6;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    
    uint256 private _tBurnTotal;

    string private _name = 'QDH Token';
    string private _symbol = 'QDH';
    uint8 private _decimals = 6;
    
    address private _burnPool = 0x000000000000000000000000000000000000dEaD;
    
    address private fundAddress = address(0x418D1C19755115CCFB7AEBEA81E7A32FBD5D1678B6);
    ...
    uint256 private _previousFundFee = _fundFee;
     uint256 public  MAX_STOP_FEE_TOTAL = 3368 * 10**uint256(_decimals);
