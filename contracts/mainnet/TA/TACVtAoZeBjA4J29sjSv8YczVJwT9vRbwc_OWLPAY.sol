...
contract OWLPAY is ERC20, ERC20Detailed{
    
    uint256 public constant initSupply = 350000000000;	
    address owner;
    ...
    constructor(address _address) public ERC20Detailed("OWLPAY", "OLP", 6){
        	owner = msg.sender;	
