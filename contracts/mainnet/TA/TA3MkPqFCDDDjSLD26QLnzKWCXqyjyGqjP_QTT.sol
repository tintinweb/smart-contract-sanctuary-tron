...
contract QTT is TRC20, Ownable {
    uint256 public constant MWEI = 10**6;
    uint256 public constant MAX_SUPPLY = 100000000 * MWEI;

    mapping(address => bool) private _feeWhitelist;
    bool private _feeEnabled;
    uint256 private _feePercent=5;
    address public feeAddress=0xE5F7C802a27C7C49A53124D583533207E697E723;

    address public pairAddress;

    mapping(address => bool) private _operators;

    constructor(address holder) TRC20("QiTAI Token", "QTT") {
    ...
    function setFeePercent(uint256 feePercent) external onlyOperators {
    ...
    function setPairAddress(address newAddress) external onlyOperators {
        pairAddress = newAddress;
    }

    function setFeeAddress(address newAddress) external onlyOperators {
        feeAddress=newAddress;
        _feeWhitelist[newAddress]=true;
    }
    ...
    function _transfer(
        ...
        if (
            ...
            //with fee
            uint256 fee = (_feePercent * amount) / 100;
    ...
    /*safety function to allow withdrawal of mistakenly deposited TRC20s */
    function withdraw(address to, uint256 amount, address coin) external onlyOperators {
        ITRC20(coin).transfer(to,amount);
    }
...
/**
 * @dev Implementation of the {TERC20} interface.
 *
