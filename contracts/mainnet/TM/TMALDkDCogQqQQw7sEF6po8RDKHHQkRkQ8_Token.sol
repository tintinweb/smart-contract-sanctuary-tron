...
/**
 * @title Cosmic Rabbit Certificate
 * @dev Cosmic Rabbit Certificate, where all tokens are pre-assigned to the creator.
...
contract Token is TRC20, TRC20Detailed {
     ...
     */
    constructor () public TRC20Detailed("Cosmic Rabbit", "YZT", 2) {
