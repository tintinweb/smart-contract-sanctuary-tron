...
contract BABYSUNCOIN  is owned {
    ...
    string constant private _name = "BABYSUNCOIN";
    string constant private _symbol = "BSC";
    uint256 constant private _decimals = 8;
    uint256 private _totalSupply;
    uint256 constant public maxSupply = 90000000 * (10**_decimals);    //9 CR tokens
    uint constant private _preMine =  90000000 * (10**_decimals);       // 9 CR token for deployer 
