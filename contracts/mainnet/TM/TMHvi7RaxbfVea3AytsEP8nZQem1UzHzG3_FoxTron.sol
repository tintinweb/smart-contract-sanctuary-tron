...
contract FoxTron {   
 ...
 // mapping (address => InvestorReferral) public investorreferrals;
  ...
  constructor() {
    ...
    tariffs.push(Tariff(182 * oneDay, 315, reg_min_invest, reg_max_invest));
    tariffs.push(Tariff(182 * oneDay, 378, pop_min_invest, pop_max_invest));
    tariffs.push(Tariff(182 * oneDay, 630, vip_min_invest, vip_max_invest));
  ...
  function initialize() public {
    ...
    require(msg.sender == devWalletAddress, "Only the contract owner can initialize the contract.");
    initialized = true;
  ...
  function invest(uint tariff, address referer) external payable  {
    require(initialized == true);
      ...
      investors[msg.sender].deposits.push(Deposit(tariff, trxAmount, block.timestamp));
  ...
  require(msg.sender == devWalletAddress); 
  ...
  function myData() public view returns (uint,bool,bool){
      ...
      uint withdrawableAmount = roi(msg.sender);
  ...
  function withdrawal() external {
    ...
    uint remainingAmt = amount - feeAmount - referralFeeAmt;
