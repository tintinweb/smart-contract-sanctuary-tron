...
contract TronexWorld {
  ...
  uint MIN_DEPOSIT1 = 50;
  uint MIN_DEPOSIT2 = 5000;
  uint MIN_DEPOSIT3 = 10000;
  uint MIN_DEPOSIT4 = 25000;
  uint MIN_DEPOSIT5 = 50000;
  uint MIN_DEPOSIT6 = 100000;
  ...
  constructor() public {
    ...
    tariffs.push(Tariff(10 * 28800, 280));
    tariffs.push(Tariff(10 * 28800, 300));
	tariffs.push(Tariff(10 * 28800, 320));
	tariffs.push(Tariff(10 * 28800, 350));
  ...
  function _deposit1(uint tariff, address referer) external payable {
    require(block.number >= START_AT);
    require(msg.value >= MIN_DEPOSIT1);
  ...
  function _deposit2(uint tariff, address referer) external payable {
    require(block.number >= START_AT);
    require(msg.value >= MIN_DEPOSIT2);
    require(tariff < tariffs.length);
  ...
  function _deposit3(uint tariff, address referer) external payable {
    require(block.number >= START_AT);
    require(msg.value >= MIN_DEPOSIT3);
    require(tariff < tariffs.length);
  ...
  function _deposit4(uint tariff, address referer) external payable {
    require(block.number >= START_AT);
    require(msg.value >= MIN_DEPOSIT4);
    require(tariff < tariffs.length);
  ...
  function _deposit5(uint tariff, address referer) external payable {
    require(block.number >= START_AT);
    require(msg.value >= MIN_DEPOSIT5);
    require(tariff < tariffs.length);
  ...
  function _deposit6(uint tariff, address referer) external payable {
    require(block.number >= START_AT);
    require(msg.value >= MIN_DEPOSIT6);
    require(tariff < tariffs.length);
