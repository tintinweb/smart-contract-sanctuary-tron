...
mapping (address => uint256[3]) private PLAYER_INVEST;
mapping (address => uint256[6]) private PLAYER_PASSIVE;
mapping (address => uint256[3]) private PLAYER_ACTIVE;
mapping (address => uint256[6][6]) private PLAYER_NETWORK;
...
function TRON_PlayerPassive(uint256 Array1) public view returns(uint256) {
return PLAYER_PASSIVE[msg.sender][Array1];
}
function TRON_PlayerActive(uint256 Array1) public view returns(uint256) {
return PLAYER_ACTIVE[msg.sender][Array1];
}
...
function TRON_PlayerEarning(uint256) public view returns(uint256) {
