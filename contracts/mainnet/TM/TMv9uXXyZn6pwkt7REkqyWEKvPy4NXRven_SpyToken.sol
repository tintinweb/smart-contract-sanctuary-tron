 ...
 * `TRC20` functions.
 */
contract SpyToken is TRC20, TRC20Detailed {

    /**
     * @dev Constructor that gives msg.sender all of existing tokens.
     */
    constructor () public TRC20Detailed("Spy Token", "SPY", 6) {
        _mint(msg.sender, 1611 * (10 ** uint256(decimals())));
    }
}
