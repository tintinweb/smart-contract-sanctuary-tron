...
/*
 *	TRX FUEL - investment platform based on TRX blockchain smart-contract technology. Safe and legit!
 *
 *   ┌───────────────────────────────────────────────────────────────────────┐  
 *   │   Website: https://trxfuel.com                                        │
 *   │                                                                       │  
 *   │   Telegram Live Support: https://t.me/Scarrletzoe                     |
 *   │   Telegram Public Group: https://t.me/TronFuel                        |
 *   │   Telegram News Channel: https://t.me/Tron_Fuel                       |
 *   |                                                                       |
 *   |   Twitter: https://twitter.com/Tron_Fuel                              |
 *   |   Discord: https://discord.gg/SQRZpk7pTY                              |
 *   |   E-mail: admin@trxfuel.com                                           |
 *   └───────────────────────────────────────────────────────────────────────┘ 
 *
 *   [USAGE INSTRUCTION]
 *
 ...
 *   - Personal hold-bonus: +0.1% for every 24 hours without withdraw Max: 1%
 *   - Contract total amount bonus: +0.1% for every 1,000,000 TRX on platform address balance Max Bonus :1%
 * 
