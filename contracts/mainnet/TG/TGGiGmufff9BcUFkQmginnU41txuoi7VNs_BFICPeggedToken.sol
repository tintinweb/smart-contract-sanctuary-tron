...
//SourceUnit: AddressBlackList.sol
...
//SourceUnit: BFICPeggedToken.sol
...
contract BFICPeggedToken is Context, IERC20 , Ownable, Pausable, AddressBlackList {
    ...
    constructor(string memory tokenname, string memory tokensymbol, uint8 tokendecimals, uint256 amount, bool ismintable, address owner) {
        _owner = owner;
        _name = tokenname;
        _symbol = tokensymbol;
