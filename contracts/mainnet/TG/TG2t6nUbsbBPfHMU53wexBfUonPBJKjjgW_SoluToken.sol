...
contract SoluToken is Context, IERC20, Ownable {
    ...
    string private _name = 'Solu Token';
    string private _symbol = 'SOLU';
    ...
    uint256 public  MAX_STOP_FEE_TOTAL = 200000000000 * 10**uint256(_decimals);
    ...
    function _transfer(address sender, address recipient, uint256 amount) private {
        ...
        if(
            ...
            sender == _uniswapPair ||
            (sender != _uniswapPair && recipient != _uniswapPair)
        )
            removeAllFee();
