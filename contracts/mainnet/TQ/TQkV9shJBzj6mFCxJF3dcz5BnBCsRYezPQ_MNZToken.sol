...
=== 'MNZ Token' Token contract with following features ===
    => TRC20 Compliance
...
-------------------------------------------------------------------
 Copyright (c) 2022 onwards MNZToken
-------------------------------------------------------------------
*/ 
...
contract MNZToken is owned {
    
    using SafeMath for uint256;

    string constant private _name = "MNZToken";
    string constant private _symbol = "MNZ";
    uint256 constant private _decimals = 8;
    uint256 private _totalSupply;                       
    uint256 private maxSupply = 990000000 * (10**_decimals);
