...
contract SIGMATOKEN  is owned {
    ...
    string constant private _name = "SIGMATOKEN";
    string constant private _symbol = "SST";
    uint256 constant private _decimals = 8;
    uint256 private _totalSupply;
    uint256 constant public maxSupply = 5000000000 * (10**_decimals);    //500 cr. tokens
    uint constant private _preMine =  5000000000 * (10**_decimals);       // 500 cr. token for deployer 
