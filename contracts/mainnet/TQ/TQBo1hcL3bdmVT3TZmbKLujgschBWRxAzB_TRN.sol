...
contract Ownable {
  ...
  function acceptTransferOwner() external {
...
contract PausableToken is StandardToken, Pausable {
  ...
  function increaseApproval(address _spender, uint _addedValue) public whenNotPaused returns (bool success) {
    require(_spender != address(0), "Address validation zero - approve");
...
contract TRN is PausableToken {
    ...
    constructor(string memory _name, string memory _symbol, uint256 _decimals, uint256 _supply, address tokenOwner) public {
        require(tokenOwner != address(0), "Address validation zero - constructor");
        name = _name;
        symbol = _symbol;
        decimals = _decimals;
    ...
    require(_who != address(0) ,"Address validation zero - burn");
