...
contract TRONRAIN {
    ...
    uint256[] public REFERRAL_PERCENTS = [250, 150, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10];
	...
	function getUserDownlineCount1(address userAddress) public view returns(uint256, uint256, uint256, uint256, uint256, uint256) {
		return (users[userAddress].level7, users[userAddress].level8, users[userAddress].level9, users[userAddress].level10, users[userAddress].level11, users[userAddress].level12);
	}
