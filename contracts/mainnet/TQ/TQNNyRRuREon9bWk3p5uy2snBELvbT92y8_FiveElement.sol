...
/**
 * @title FiveElement
 * @dev TRC20 Token FiveElement, where all tokens are pre-assigned to the creator.
 * Note they can later distribute these tokens as they wish using `transfer` and other
 * `TRC20` functions.
 */
contract FiveElement is TRC20, TRC20Detailed, Ownable {

    /**
     * @dev Constructor that gives msg.sender all of existing tokens.
     */
    constructor(string memory _name, string memory _symbol, uint8 _decimals, uint _total) public TRC20Detailed(_name, _symbol, _decimals) {
