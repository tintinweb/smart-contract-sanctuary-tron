...
contract SFAMBBWAC22 is ERC721Full, Ownable {
    uint256 private constant _TOTAL_SUPPLY_LIMIT = 50;

    constructor() public ERC721Full("SFAMBBWAC22", "SFAMBB22") {
    _setBaseURI("https://purplelightsvault.com/wp-content/uploads/2022/03/22MBBWACChamps.json");
    }
