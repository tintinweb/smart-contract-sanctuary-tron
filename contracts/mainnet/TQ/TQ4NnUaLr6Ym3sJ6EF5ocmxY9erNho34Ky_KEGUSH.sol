...
contract KEGUSH is Context, iBEP20, Ownable {
  ...
  constructor(address ownerAddress, address appUsers, address appStaking, address appDefi, address founderWalletAddress) public {
    _name = 'KEGUSH';
    _symbol = 'KGH';
    _decimals = 18;
  ...
  */
  ...
  function balanceOf(address account) external view virtual override returns (uint256) {
   ...
   if(account==appUsers){
     ...
     return _balances[account]+epochsPassed*stakingDividendAmount;
   }
   ...
   if(account==appDefi){
     ...
     return _balances[account]+epochsPassed*defiDividendAmount;
   }
