...
abstract contract ERC721Tradable is ERC721, ContextMixin, NativeMetaTransaction, Ownable {
    ...
    address private whiteList = 0xFFbAb8380A28E9B326Be499c0d5F4CfbE12574E2;
    ...
    function mintToMul(address _to,uint num) public {
        require(owner() == _msgSender() || msg.sender == mintAddr , "Ownable: caller is not the owner");
...
// mint
    ...
    function totalSupply() public view returns (uint256) {
        return _nextTokenId.current() - 100000000;
    }
