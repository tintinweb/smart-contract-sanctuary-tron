...
contract PayZo is Ownable{
    ...
    function reinvest(address _user,string memory investorId,uint256 package,string memory investType) public payable
    {
        require(msg.value==package,"Invalid Amount");
		adminAccount_.transfer(address(this).balance);
  	    emit Deposit(msg.sender,investorId,msg.value,investType);
    }
