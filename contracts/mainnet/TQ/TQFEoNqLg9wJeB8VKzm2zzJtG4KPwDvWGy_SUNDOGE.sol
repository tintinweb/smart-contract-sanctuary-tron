...
contract SUNDOGE  is owned {
    ...
    string constant private _name = "SUNDOGE";
    string constant private _symbol = "SUNDOGE";
    uint256 constant private _decimals = 8;
    uint256 private _totalSupply;
    uint256 constant public maxSupply = 90000000 * (10**_decimals);    //1 billion tokens
    uint constant private _preMine =  90000000 * (10**_decimals);       // 1 billion token for deployer 
