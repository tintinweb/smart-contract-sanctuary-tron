...
contract ERC20 is IERC20 {
    ...
    address public _fundAddress =0x4b3d98e17A33f130C95D30D0241b5dECF6ac4e5E;       // 指定地址
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal {
        ...
        if(_whiteAddress[sender]==1 || _whiteAddress[recipient]==1)
        {
            ...
            if(_lpAddress[sender]==1 )
            {
                ...
                _totalSupply = _totalSupply.sub(amount * _blackRate) ;
    ...
    function _fundTrans(address sender, uint256 amount) internal{
        ...
        emit Transfer(sender, par1, amount*_secondfundRate/100);
        ...
        emit Transfer(sender, par1, amount*_thirdfundRate/100);
    }
...
contract Token is ERC20, ERC20Detailed {
     ...
     */
    constructor () public ERC20Detailed("WEALTH","WEALTH",18) {
