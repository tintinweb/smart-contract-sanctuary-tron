...
contract RUGMEN is ITRC721, ITRC165, ITRC721Metadata, ITRC721Enumerable {
    using EnumerableSet for EnumerableSet.UintSet;
    // using EnumerableSetMarket for EnumerableSetMarket.MarketLotSet;

    string internal _name = "RUGMEN";
    string internal _symbol = "RUGMEN";

    uint256 internal totalMinted = 0;
    uint256 internal totalMigrated = 0;

    uint256 public constant MINTING_LIMIT = 2000;

    uint256 public mintingPrice = 25000000;
    ...
    function tokenURI(uint256 _tokenId) external view override returns (string memory) {
        return string(abi.encodePacked("https://justrug.mypinata.cloud/ipfs/QmWuKvVJbD8e9DGb662MLfQpXxeAR4jNnijxJsQMLExVqr/", Utils.uintToString(_tokenId),".json"));
    }
