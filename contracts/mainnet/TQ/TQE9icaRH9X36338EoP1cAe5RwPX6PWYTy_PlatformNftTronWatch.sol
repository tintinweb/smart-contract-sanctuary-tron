...
contract PlatformNftTronWatch is Context, TRC721Burnable {
...
//Minting
uint256 public constant TOKEN_PRICE = 14599990  trx;//1500 trx;
...
constructor() public TRC721("JustinWatch", "JWCH") {
_owner = _msgSender();
receiver = _owner;
}
...
function tokenURI(uint256 tokenId) public view virtual override returns (string memory){
//assert(tokenId == 1);
return "https://justinnft.watch/tokenMetadata.json";
}
...
function setReceiver(address _receiver) public _ownerOnly {
receiver = _receiver;
}
