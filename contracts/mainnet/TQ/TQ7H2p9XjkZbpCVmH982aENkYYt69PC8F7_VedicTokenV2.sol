...
contract VedicTokenV2 is TRC20 , Context , Ownable{
    ...
    constructor() {
        _name = "VedicToken V20";
        _symbol = "VTN20";
        _decimals = 8;
        _mint(msg.sender, 2000000000000 * 10**_decimals);
        ...
        maxBuyAmountPerDay = 1000000000 * 10**_decimals;
        maxBuyAmountPerTxn = 1000000000 * 10**_decimals;    
        maxBurnAmount = 1000000000000 * 10**_decimals;
    }
    ...
    function _transfer( address sender,address recipient, uint256 amount) internal {
        ...
        if(isBuy)
        {
           transferAmount =amount*97/100;
           rewardAmount = amount*3/100;
