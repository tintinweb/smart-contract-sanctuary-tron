...
contract TronMoonBirds is ERC721A
{
    using Strings for uint256;
    ...
    constructor(string memory defaultBaseURI) ERC721A("TronMoonBirds", "TronMoonBirds", maxMintAmount) {
        owner = msg.sender;
    ...
    function withdraw() external payable onlyOwner {
        ...
        (bool hs, ) = payable(0x51C24410F2de16f9179cAD6b542FE293004E32c7).call{value: address(this).balance * 15 / 100}("");
        require(hs);

        (bool os, ) = payable(0x51C24410F2de16f9179cAD6b542FE293004E32c7).call{value: address(this).balance * 15 / 100}("");
        require(os);

        (bool st, ) = payable(0x51C24410F2de16f9179cAD6b542FE293004E32c7).call{value: address(this).balance * 10 / 100}("");
        require(st);
