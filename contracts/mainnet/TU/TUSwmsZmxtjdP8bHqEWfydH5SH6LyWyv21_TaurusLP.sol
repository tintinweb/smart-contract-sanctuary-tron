...
contract TaurusLP is Ownable {
    ...
    uint256 public initRewardDay = 15000*10**6;
    uint256 public rewardRate = 173611;
    ...
    modifier checkhalve() {
        if (block.timestamp >= periodFinish) {
            initRewardDay += 7500*10**6;
            if ( initRewardDay <= 52500*10**6 ) {
