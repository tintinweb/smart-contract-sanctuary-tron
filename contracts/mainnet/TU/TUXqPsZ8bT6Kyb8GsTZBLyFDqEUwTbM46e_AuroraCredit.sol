...
contract AuroraCredit is Ownable {
    ...
    address payable public PROMOTION_ADDRESS = address(0x418be064940f49fe68488f3f2c39d8ec1d00dce139);
    uint256[4] public PROMOTION_PERCENTS = [20, 20, 20, 20]; 

    address payable public constant DEFAULT_REFERRER = address(0x41d1efd33b78faac770eea7c6dffecc839c11cf437);
