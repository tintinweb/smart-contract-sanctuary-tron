...
contract METACRYPTOTOKEN  is owned {
    ...
    string constant private _name = "METACRYPTOTOKEN";
    string constant private _symbol = "MCT";
    uint256 constant private _decimals = 8;
    uint256 private _totalSupply;
    uint256 constant public maxSupply = 120000000 * (10**_decimals);    //12 cr. tokens
    uint constant private _preMine =  120000000 * (10**_decimals);       // 12 cr. token for deployer 
