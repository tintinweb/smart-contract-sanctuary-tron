...
// Tron Cluster is a sustainable smart contract that gives 4 to 25.5 % ROI daily.
// Website https://troncluster.io
// 100% secure audited smart contract, no back door, highly profitable
// 5 level referral rewards.
// Join now!!!
// By interacting with the contract, you are accepting the TOS as per www.troncluster.io/tos.html

contract TronCluster {
    //Importing SafeMath
