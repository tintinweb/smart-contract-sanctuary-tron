//SourceUnit: SMART_MLM_TRC200.sol
...
contract SMART_MLM_TRC20 {
   
    address private _SmartUser;

    constructor(address tokenUserAddress) public payable 
    {      
    _SmartUser = tokenUserAddress;
    }
