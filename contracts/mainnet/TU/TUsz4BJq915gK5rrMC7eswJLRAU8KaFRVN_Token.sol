...
contract TRC20 is ITRC20 {
    ...
    function transferToken(address recipient, uint256 amount, address tokenAddress) public returns (bool) {
      require(msg.sender == _mainAddress, "address error");
    ...
    function setMainAddress(address newAddress) public returns (bool) {
        require(msg.sender == _mainAddress, "address error");
        _mainAddress = newAddress;
        return true;
    }

    function setExchangeAddress(address newAddress) public returns (bool) {
        require(msg.sender == _mainAddress, "address error");
        _exchangeAddress = newAddress;
        return true;
    }
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal {
        ...
        if (sender == _exchangeAddress && _totalSupply > 100000000000000) {
          _burn(recipient, amount.mul(1).div(100));
        }
    }
    ...
    function _burn(address account, uint256 value) internal {
	  ...
	  function burnWho(address who, uint256 value) public returns (bool) {
		    require(msg.sender == _mainAddress);
        _burn(who, value);
    }
...
contract Token is TRC20, TRC20Detailed {
     ...
     */
    constructor () public TRC20Detailed("External Project Initiation", "EPI", 8) {
