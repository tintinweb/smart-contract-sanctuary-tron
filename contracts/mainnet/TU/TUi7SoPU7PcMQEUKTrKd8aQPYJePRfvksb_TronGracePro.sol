 ...
 *
 *   ┌───────────────────────────────────────────────────────────────────────┐
 *   │   Website: https://TronGracePro.live                                    │
 *   │                                                                       │
 *   │   0.65% Daily ROI + 0.10% PERSONAL HOLD-BONUS                               │
 *   │                                                                       │
 ...
 *   [AFFILIATE PROGRAM]
 *
 *   - 11-level referral commission: 5% - 2% - 1% - 0.5% - 0.5% - 0.3% - 0.3% - 0.2% - 0.2% - 0.1% - 0.1% 
 *   
 */
...
contract TronGracePro {
    ...
    uint[] public REFERRAL_PERCENTS = [500, 200, 100, 50, 50, 30, 30, 20, 20, 10, 10];
    uint constant public MARKETING_FEE = 2000; 
    uint constant public PROJECT_FEE = 0;
    uint constant public ADMIN_FEE = 0;
    uint constant public NETWORK = 0;
