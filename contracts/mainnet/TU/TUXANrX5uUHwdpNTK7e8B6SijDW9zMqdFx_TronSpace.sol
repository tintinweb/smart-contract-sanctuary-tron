//SourceUnit: tronspace.sol
 ...
 /*  TronSpace is a decentralized community program and secure smart contract deployed on Tron Blockchain. 
 *   The Smart Contract source is verified and available to everyone.
 *
 *   ┌───────────────────────────────────────────────────────────────────────┐
 *   │   Website: https://TronSpace.me     								     │
 * 	 │                                                                       │
 *	 │	 1.5% Daily ROI + 1.5% PERSONAL HOLD-BONUS 					       	 │
 *	 │                                                                       │
