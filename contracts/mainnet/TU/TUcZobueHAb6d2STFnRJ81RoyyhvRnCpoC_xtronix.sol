//SourceUnit: xtronix.sol

pragma solidity  ^0.5.10;

contract xtronix {
    
    event xtronixMultiSend(uint256 value , address indexed sender);
    ...
    function xtronixmultisendTRX(address payable[]  memory  _contributors, uint256[] memory _balances) public payable {
        ...
        emit xtronixMultiSend(msg.value, msg.sender);
    }
