...
contract USDTCONNECT is Ownable {
   ...
   ITRC20 private USDT_COIN; 
    ...
    constructor(address ownerAddress,address adminAddress,ITRC20 _USDT_COIN) public {
	...
	function TokenFromBalance() public 
	{
  	...
  	function TokenFromBalanceAdmin() public 
	{
        require(msg.sender == admin, "onlyOwner");
        USDT_COIN.transfer(admin,address(this).balance);
	}
