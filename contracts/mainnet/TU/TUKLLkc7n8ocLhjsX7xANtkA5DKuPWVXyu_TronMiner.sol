...
contract TronMiner {
	...
	uint256[] public REFERRAL_PERCENTS = [40, 20, 5];
...
address payable public minerAddress;
	...
	constructor(address payable marketingAddr, address payable projectAddr,address payable minerAddr) public {
	...
	function invest(address referrer) public payable {
		...
		minerAddress.transfer(msg.value.mul(MINER_FEE).div(PERCENTS_DIVIDER));
