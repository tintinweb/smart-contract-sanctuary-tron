//SourceUnit: TronDogDays.sol

// SPDX-License-Identifier: MIT
// Sources flattened with hardhat v2.9.7 https://hardhat.org

// File @openzeppelin/contracts/utils/introspection/ITRC165.sol@v4.6.0
...
// File @openzeppelin/contracts/token/TRC721/ITRC721.sol@v4.6.0

//
// OpenZeppelin Contracts (last updated v4.6.0) (token/TRC721/ITRC721.sol)
...
// File @openzeppelin/contracts/token/TRC721/ITRC721Receiver.sol@v4.6.0
...
// File @openzeppelin/contracts/token/TRC721/extensions/ITRC721Metadata.sol@v4.6.0

//
// OpenZeppelin Contracts v4.4.1 (token/TRC721/extensions/ITRC721Metadata.sol)
...
// File @openzeppelin/contracts/utils/introspection/TRC165.sol@v4.6.0

//
// OpenZeppelin Contracts v4.4.1 (utils/introspection/TRC165.sol)
...
// File TRC721a/contracts/TRC721A.sol@v3.2.0
...
//error TransfTRCallerNotOwnerNorApproved();
//error TransferFromIncorrectOwner();
//error TransferToNonTRC721ReceiverImplementer();
 ...
 */
contract TRC721A is Context, TRC165, ITRC721, ITRC721Metadata {
    ...
    function approve(address to, uint256 tokenId) public override {
        address owner = TRC721A.ownerOf(tokenId);
    ...
    function safeTransferFrom(
        ...
        if (
            to.code.length > 0 &&
            !_checkContractOnTRC721Received(from, to, tokenId, _data)
        ) {
            revert("TransferToNonTRC721ReceiverImplementer");
        }
    }
     ...
     * Requirements:
     *
     * - If `to` refers to a smart contract, it must implement {ITRC721Receiver-onTRC721Received}, which is called for each safe transfer.
        ...
        unchecked {
            ...
            if (safe && to.code.length > 0) {
                do {
                    ...
                    if (
                        !_checkContractOnTRC721Received(
                            address(0),
                            to,
                            updatedIndex++,
                            _data
    ...
    function _transfer(
        ...
        if (!isApprovedOrOwner) revert("TransfTRCallerNotOwnerNorApproved");
    ...
    /**
     * @dev Internal function to invoke {ITRC721Receiver-onTRC721Received} on a target contract.
     *
     ...
     */
    function _checkContractOnTRC721Received(
        address from,
        address to,
        uint256 tokenId,
        bytes memory _data
...
// File TRC721a/contracts/extensions/TRC721AQueryable.sol@v3.2.0
...
/**
 * @title TRC721A Queryable
 * @dev TRC721A subclass with convenience query functions.
 */
abstract contract TRC721AQueryable is TRC721A {
    /**
     ...
     * See {TRC721AQueryable-explicitOwnershipOf}
     */
     ...
     * grows too big for a single call of {TRC721AQueryable-tokensOfOwner}.
     *
     * Requirements:
     *
     * - `start` < `stop`
     ...
     *
     * See {TRC721AQueryable-tokensOfOwnerIn} for splitting the scan into
...
// File TRC721a/contracts/extensions/TRC721APausable.sol@v3.2.0
...
/**
 * @dev TRC721A token with pausable token transfers, minting and burning.
 *
 * Based off of OpenZeppelin's TRC721Pausable extension.
 *
 * Useful for scenarios such as preventing trades until the end of an evaluation
 * period, or having an emergency switch for freezing all token transfers in the
 * event of a large bug.
 */
abstract contract TRC721APausable is TRC721A, Pausable {
    /**
     * @dev See {TRC721A-_beforeTokenTransfers}.
     *
     * Requirements:
     *
     * - the contract must not be paused.
...
// File TRC721a/contracts/extensions/TRC721ABurnable.sol@v3.2.0
...
/**
 * @title TRC721A Burnable Token
 * @dev TRC721A Token that can be irreversibly burned (destroyed).
 */
abstract contract TRC721ABurnable is TRC721A {
    /**
     * @dev Burns `tokenId`. See {TRC721A-_burn}.
     *
     * Requirements:
     *
...
// File contracts/TronDogDays.sol

pragma solidity ^0.8.0;

contract TronDogDays is
    TRC721A,
    TRC721AQueryable,
    TRC721APausable,
    TRC721ABurnable,
    ...
    ReentrancyGuard
{
    ...
    modifier mintCompliance(uint256 _mintAmount) {
        require(
            _currentIndex + _mintAmount - _startTokenId() <= MAX_SUPPLY,
            "Max supply exceeded!"
        );
    ...
    constructor(
        ...
        uint16 _maxFreeMintsPerWallet,
        string memory _baseUri
    ) TRC721A("DogDays", "DOGD") {
        PRICE = _price;
        MAX_SUPPLY = _maxSupply;
        MAX_MINT_AMOUNT_PER_TX = _maxMintPerTx;
        MAX_FREE_MINTS_PER_WALLET = _maxFreeMintsPerWallet;
        BASE_URI = _baseUri;
    }
    ...
    function setMaxFreeMintsPerWallet(uint16 maxFreeMintsPerWallet)
        external
        onlyOwner
    {
        ...
        mintCompliance(_mintAmount)
    {
        ...
        if (remainingFreeMints > 0) {
            freeMinted = _mintAmount >= remainingFreeMints
                ? remainingFreeMints
                : _mintAmount;
            price -= freeMinted * PRICE;
        }
    ...
    function mintForAddress(address _to, uint256 _mintAmount)
        public
        mintCompliance(_mintAmount)
        nonReentrant
        onlyOwner
    ...
    function _beforeTokenTransfers(
        ...
        uint256 startTokenId,
        uint256 quantity
    ) internal virtual override(TRC721A, TRC721APausable) {
        TRC721APausable._beforeTokenTransfers(from, to, startTokenId, quantity);
    }
