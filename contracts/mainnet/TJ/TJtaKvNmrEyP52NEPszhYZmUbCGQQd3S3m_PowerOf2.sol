...
*  | $$     | $$  | $$| $$ | $$ | $$| $$_____/| $$      | $$  | $$| $$      | $$      
*  | $$     |  $$$$$$/|  $$$$$/$$$$/|  $$$$$$$| $$      |  $$$$$$/| $$      | $$$$$$$$
*  |__/      \______/  \_____/\___/  \_______/|__/       \______/ |__/      |________/
*
*/
...
contract PowerOf2 {
    ...
    function registration(address userAddress, address referrerAddress) private {
        require(msg.value == 400 trx, "Registration Cost is 400");
    ...
    function updateX6Referrer(address userAddress, address referrerAddress, uint8 level) private {
        require(users[referrerAddress].activeX6Levels[level], "20. Referrer level is inactive");
