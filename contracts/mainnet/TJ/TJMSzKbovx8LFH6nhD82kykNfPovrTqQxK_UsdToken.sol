...
contract UsdToken is ITRC20, TRC20Detailed {
    constructor(address gr) public TRC20Detailed("USD TOKEN", "USDT", 18){
        require(gr != address(0), "invalid gr");
        _mint(gr, 3000000000 * 10 ** 18);
    }
}
/**
 构造函数参数填写创建者地址
