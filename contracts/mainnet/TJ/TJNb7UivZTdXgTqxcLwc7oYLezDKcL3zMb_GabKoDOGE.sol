...
//SourceUnit: GabKoDOGE.sol

// GabKoDOGE (GABD) standard token "StableCoin"
// Creator : Enrigo g Gartier
// SPDX-License-Identifier: MIT
 ...
 */
/***********************************************************/
/* GabKoDOGE (GABD) TOKEN STARTS HERE */
/***********************************************************/
contract GabKoDOGE is Authorizable, TRC20, TRC20Detailed {
     ...
     */
    constructor () TRC20Detailed("GabKo DOGE", "GABD", 8) {
...
abstract contract TRC20Detailed is ITRC20 {
     ...
     * construction.
     */
    constructor (string memory tokenName, string memory tokenSymbol, uint8 initialDecimals) {
        _name = tokenName;
        _symbol = tokenSymbol;
