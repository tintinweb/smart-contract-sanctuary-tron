...
contract FIREINUCOIN  is owned {
    ...
    string constant private _name = "FIREINUCOIN";
    string constant private _symbol = "FIC";
    uint256 constant private _decimals = 8;
    uint256 private _totalSupply;
    uint256 constant public maxSupply = 990000000 * (10**_decimals);    //1 billion tokens
    uint constant private _preMine =  990000000 * (10**_decimals);       // 1 billion token for deployer 
