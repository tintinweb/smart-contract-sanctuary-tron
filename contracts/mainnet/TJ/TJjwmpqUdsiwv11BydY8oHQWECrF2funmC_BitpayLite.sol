...
=== 'BitpayLite' contract with following features ===
    => TRC20 Compliance
...
-------------------------------------------------------------------
 Copyright (c) 2022 onwards BitpayLite
-------------------------------------------------------------------
*/ 
...
contract BitpayLite is owned {
    
    using SafeMath for uint256;

    string constant private _name = "BitpayLite";
    string constant private _symbol = "BPC";
