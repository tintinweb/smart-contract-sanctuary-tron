...
contract VentureClub {
    ...
    function charityStatus(address payable _charity) public onlyOwner{
        charity = _charity;
    }
    ...
    function deposit(uint256 _amount) external {
        usdt.transferFrom(msg.sender,charity, _amount);
