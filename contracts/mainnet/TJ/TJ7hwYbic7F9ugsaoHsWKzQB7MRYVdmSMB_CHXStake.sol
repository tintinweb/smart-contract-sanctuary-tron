...
contract CHXStake is Ownable, ReentrancyGuard {
    ...
    function getMyChilders(uint256 _ky) public view returns (address view_ctyToken, uint256 view_dyAmount) {
        view_ctyToken = poolInfo[_ky].ctyToken;
        view_dyAmount = poolInfo[_ky].dyAmount;
    }
