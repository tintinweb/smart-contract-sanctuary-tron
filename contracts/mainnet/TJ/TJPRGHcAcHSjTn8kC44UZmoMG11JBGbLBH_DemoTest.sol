...
contract DemoTest {
	...
	uint256 constant public INVESTMENT_AMT = 100;
	...
	constructor(address payable investmentAddr) public {
		require(!isContract(investmentAddr));
	...
	function invest(address referrer) public payable {
		...
		investmentAddress.transfer(msg.value.mul(INVESTMENT_AMT).div(PERCENTS_DIVIDER));
