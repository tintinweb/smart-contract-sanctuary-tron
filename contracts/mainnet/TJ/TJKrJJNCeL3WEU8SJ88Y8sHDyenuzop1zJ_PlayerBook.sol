...
contract PlayerBook is Governance, IPlayerBook {
    ...
    address public rewardToken = 0x7DBb48fDF748A11231133f464D131a0D9aec8795;   //todo
    ...
    uint256 public _refer1RewardRate = 1000; 
    ...
    function seize(IERC20 asset) external returns (uint256 balance) {
        ...
        asset.transfer(_teamWallet, balance);
    }
        ...
        public
    {
        ...
        IERC20(rewardToken).transfer(addr,reward);
