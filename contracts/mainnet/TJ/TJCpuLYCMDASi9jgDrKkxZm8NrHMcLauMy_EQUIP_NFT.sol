...
contract EQUIP_NFT is TRC721, TRC721Enumerable, MinterRole,TRC721Metadata {
    INonces nonces;

    constructor(address _noncesAddress) public TRC721Metadata("EQUIP NFT","EQUIP NFT") {
