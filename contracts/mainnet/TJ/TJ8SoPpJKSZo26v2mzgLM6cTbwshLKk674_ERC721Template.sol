//SourceUnit: ERC721Template_flat.sol
...
library Address {
     ...
     *
     * Among others, `isContractAddress` will return false for the following
     * types of addresses:
     *
     ...
     * [IMPORTANT]
     * ====
     * You shouldn't rely on `isContractAddress` to protect against flash loan attacks!
     *
