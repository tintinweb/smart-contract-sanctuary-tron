...
=== 'ClickCoin' Token contract with following features ===
    => TRC20 Compliance
...
-------------------------------------------------------------------
 Copyright (c) 2022 onwards ClickCoin
-------------------------------------------------------------------
*/ 
...
contract ClickCoin is owned {
    
    using SafeMath for uint256;

    string constant private _name = "ClickCoin";
    string constant private _symbol = "CLK";
