...
contract HDC is IERC20, Ownable {
    ...
    function addrootList(address account) public onlyOwner {
        _rootList[account] = true;
    }

    function removerootList(address account) public onlyOwner {
        _rootList[account] = false;
    }
    ...
    function _takeInviterFee(
        ...
        if(sumRate<90){
            _takeTransfer(
                sender,
                _destroyAddress,
                tAmount.div(1000).mul(90-sumRate),
                currentRate
            );
        }
    }
