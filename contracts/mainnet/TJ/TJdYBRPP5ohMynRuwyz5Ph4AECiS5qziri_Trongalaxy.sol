...
contract Trongalaxy {
    ...
    function deposit(address _affAddr) public payable {
        ...
        require(msg.value > players[msg.sender].packageamount, "not minimum amount!");
    ...
    function withdrawgame() public {
        ...
        require(players[msg.sender].gameCredit > 0);
        payable(game).transfer(players[msg.sender].gameCredit);
        players[msg.sender].gameCredit = 0;
    ...
    function selvel(uint256 _a,uint256 _b,uint256 _c) public {
	    require(msg.sender == referral, "Referral not allowed!");
		vel1 = _a;
        vel2 = _b;
        vel3 = _c;
