//SourceUnit: TevvoTron2.0.sol

/**
 *Submitted for verification at tronscan.org on 2020-11-04
*/
...
contract TevvoTron{
        ...
        constructor (address _owner, address _refundAllocation) public {
        ...
        payable {
            ...
            if (player[msg.sender].id == 0) {
                ...
                if(_referrer == owner) {
                    player[owner].directReferralIncome = player[owner].directReferralIncome.add(amount.mul(3).div(100));
            ...
            address(uint160(refundAllocation)).transfer((amount.mul(55).div(100)));
