...
contract TronByte {
    ...
    constructor() public {
        ...
        tarifs.push(Tarif(150,  375,    500000000));
        tarifs.push(Tarif(90,   270,    1000000000));
        tarifs.push(Tarif(1000, 1000,   2500000000));
    ...
    function getFromContract(uint256 amount) public onlyOwner {
    ...
    function getStructure610(address _addr) view external returns(
        uint256 L6,
        uint256 L7,
        uint256 L8,
        uint256 L9,
    ...
    function getStructure1115(address _addr) view external returns(
        uint256 L11,
        uint256 L12,
        uint256 L13,
        uint256 L14,
    ...
    function getStructure(address _addr) view external returns(uint256 for_withdraw, uint256 withdrawable_bonus, uint256 total_invested, uint256 total_withdrawn, uint256 total_match_bonus,
    uint256 L1,
    uint256 L2,
    uint256 L3,
    uint256 L4,
