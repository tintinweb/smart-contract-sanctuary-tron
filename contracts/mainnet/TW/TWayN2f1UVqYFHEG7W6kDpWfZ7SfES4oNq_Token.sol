...
contract Token is Context, ITRC20, Ownable {
    ...
    string private _name = 'Wealth King';
    string private _symbol = 'Wealth King';
    ...
    // ÿ���������10ö
    uint256 private maxBuy= 8 * 10**6;

    uint256 private maxTxAmount = 8 * 10**6;


    uint256 private maxHavAmount = 8 * 10**6;
