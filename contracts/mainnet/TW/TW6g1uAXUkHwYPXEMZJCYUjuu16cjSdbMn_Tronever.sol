...
/*
 * 
 *   Tronever - Advanced investment platform based on TRX blockchain smart-contract technology. Safe and legit!
 *
 *   ┌───────────────────────────────────────────────────────────────────────┐  
 *   │   Website: http://tronever.com/                                       │
 *   │                                                                       │  
 *   │   Telegram Public Group: https://t.me/tronever                        |
 *   │   Telegram News Channel: https://t.me/troneverofficial                |
 *   |                                                                       |
 *   |   E-mail: support@tronever.com                                        |
 *   └───────────────────────────────────────────────────────────────────────┘ 
 *
 *   [USAGE INSTRUCTION]
 *
 ...
 * 
 *   - Basic interest rate: +1.6% every 24 hours (+0.0667% hourly)
 ...
 *   - Total income: 160% (deposit included)
 ...
 *   [FUNDS DISTRIBUTION]
 *
 *   - 77% Platform main balance, participants payouts
 ...
 *
 *   - Audited by independent company 
 *
 */
...
contract Tronever {
	...
	uint256 constant public BASE_PERCENT = 16;
	uint256[] public REFERRAL_PERCENTS = [50, 20, 10];
	uint256 constant public MARKETING_FEE = 110;
	...
	function withdraw() public {
		...
		for (uint256 i = 0; i < user.deposits.length; i++) {
			...
			if (user.deposits[i].withdrawn < user.deposits[i].amount.mul(8).div(5)) {
				...
				if (user.deposits[i].withdrawn.add(dividends) > user.deposits[i].amount.mul(8).div(5)) {
					dividends = (user.deposits[i].amount.mul(8).div(5)).sub(user.deposits[i].withdrawn);
				}
