...
contract SFAWBBWAC22 is ERC721Full, Ownable {
    uint256 private constant _TOTAL_SUPPLY_LIMIT = 50;

    constructor() public ERC721Full("SFAWBBWAC22", "SFAWBB22") {
    _setBaseURI("https://purplelightsvault.com/wp-content/uploads/2022/03/22WBBWACChamps.json");
    }
