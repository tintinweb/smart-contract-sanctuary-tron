...
// File: contracts/tronFightClub.sol
...
contract tronFightClub is ERC721A, Ownable{
    using Strings for uint256;

    string public baseURI;

    uint256 public cost = 690 trx;
    ...
    constructor() ERC721A("Tron Fight Club", "TFC") {
