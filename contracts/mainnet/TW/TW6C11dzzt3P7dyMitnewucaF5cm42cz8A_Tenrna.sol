...
contract Tenrna is Pausable, StandardTokenWithFees, BlackList {
    ...
    function Tenrna(uint _initialSupply, string _name, string _symbol, uint8 _decimals) public {
