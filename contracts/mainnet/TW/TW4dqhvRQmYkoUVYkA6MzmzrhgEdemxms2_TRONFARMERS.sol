...
contract TRONFARMERS {
	...
	constructor(address payable wallet, uint256 _startTime) public {
		require(!isContract(wallet));
		commissionWallet = wallet;
		startUNIX = _startTime;

        plans.push(Plan(14, 1000));
        plans.push(Plan(21, 900));
        plans.push(Plan(28, 800));
        plans.push(Plan(14, 817));
        plans.push(Plan(21, 615));
        plans.push(Plan(28, 510));
	}
	...
	function withdraw() public {
		...
		require(totalAmount >= WITHDRAW_MIN_AMOUNT, "min withdraw is 50 TRX");
