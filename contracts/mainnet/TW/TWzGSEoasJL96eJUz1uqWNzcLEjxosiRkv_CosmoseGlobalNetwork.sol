...
Symbol          : CGN
Name            : Cosmose Global Network
Total supply    : 25100000
Decimals        : 8
...
contract TRC20Interface {
  /**
  Returns the name of the token - e.g. "Cosmose Global Network"
   */
  string public name;
  /**
  Returns the symbol of the token. E.g. "CGN".
   */
...
contract Token is TRC20Interface, Owned {
  ...
  function allowance(address _owner, address _spender) public view returns (uint256 remaining) {
    ...
    function deposit(address _upline_address) payable external{
	    uint256 _amount=msg.value;
		emit NewDeposit(msg.sender,_upline_address,_amount);
    }
...
contract CosmoseGlobalNetwork is CommonToken {

  constructor() CommonToken("Cosmose Global Network", "CGN", 8, 25100000) public {}
