...
/**
 * @title TokenVest Dinar
 * @dev Token TRC20 represent ownership, voting power, shares of TokenVest Wallet App, where all tokens are pre-assigned to the creator, contributor and community.
 * Note they can later distribute these tokens using `transfer` and other
 * `TRC20` functions.
 */
contract Token is TRC20, TRC20Detailed {
     ...
     */
    constructor () public TRC20Detailed("TokenVest Dinar", "TVD", 6) {
