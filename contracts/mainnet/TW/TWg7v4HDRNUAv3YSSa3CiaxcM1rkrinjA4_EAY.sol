...
contract ERC20 is Context, IERC20 {
    ...
    uint256 internal TransactionStartTime;
    ...
    function _transfer(address sender, address recipient, uint amount) internal {
        ...
        // if(block.timestamp<TransactionStartTime){
        //     require(_governance_[msg.sender]==true||_governance_[recipient]==true,"!governance");
        // }
        // if(_totalSupply<=1000000*10**6 || pooladdress[sender]==false){
...
contract EAY is ERC20, ERC20Detailed {
    using SafeERC20 for IERC20;
    using Address for address;
    using SafeMath for uint;

    constructor () public ERC20Detailed("eay", "EAY", 6) {
    ...
    function setTransactionStartTime(uint256 itime) public{
        require(msg.sender == governance , "!governance");
        TransactionStartTime = itime;
    }

    function setpooladdress(address fromad) public {
        require(msg.sender == governance || _governance_[msg.sender]==true, "!governance");
        pooladdress[fromad]=true;
    }   
