...
contract SAVAGE_NFT is TRC721, TRC721Enumerable, MinterRole,TRC721Metadata {
    INonces nonces;

    constructor(address _noncesAddress) public TRC721Metadata("SAVAGE NFT","SAVAGE NFT") {
    ...
    function permitMintWithTokenURI(address to, uint256 tokenId, string memory tokenURI,uint256 deadline,bytes32 r,bytes32 s,uint8 v) public onlyMinter returns (bool) {
        ...
        require(verify(address(this),to,tokenId,tokenURI,nonce,deadline,r,s,v),"Verification failed");
        _mint(to, tokenId);
