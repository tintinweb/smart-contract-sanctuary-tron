...
contract AawazTron is ITRC20, TRC20Detailed, Ownable {
    constructor(address mintAddress) public TRC20Detailed("aawaz", "AWAZ", 6) {
        require(mintAddress != address(0), "invalid mint Address");
        mint(mintAddress, 100_000 * 10**6);
    }
...
contract PetiTron is ITRC20, TRC20Detailed, Ownable {
    constructor(address mintAddress) public TRC20Detailed("peti", "PETI", 6) {
        require(mintAddress != address(0), "invalid mint Address");
        mint(mintAddress, 100_000 * 10**6);
    }
