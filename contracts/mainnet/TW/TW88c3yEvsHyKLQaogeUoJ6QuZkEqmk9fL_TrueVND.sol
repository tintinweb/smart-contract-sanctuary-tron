...
contract TrueVND is Pausable, StandardTokenWithFees, BlackList {

    address public upgradedAddress;
    bool public deprecated;
    
    function TrueVND() public {
       //~100M USD
        _totalSupply = 23999000000000000000;
        name = "TrueVND";
        symbol = "TVND";
        decimals = 8;
    ...
    // function TrueVND(uint _initialSupply, string _name, string _symbol, uint8 _decimals) public {
