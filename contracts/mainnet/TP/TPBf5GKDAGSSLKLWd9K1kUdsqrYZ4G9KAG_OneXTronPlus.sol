...
contract OneXTronPlus {
    ...
    uint constant public BASE_PERCENT = 460;
    uint[] public REFERRAL_PERCENTS = [1000, 300, 100, 50, 20 ];
    uint constant public ADMIN_FEE = 300;
    uint constant public MARKETING_FEE = 300;
    uint constant public MAX_CONTRACT_PERCENT = 200;
    uint constant public MAX_LEADER_PERCENT = 200;
    uint constant public MAX_HOLD_PERCENT = 340;
