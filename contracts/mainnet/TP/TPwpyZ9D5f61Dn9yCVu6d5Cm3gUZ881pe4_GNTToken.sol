...
contract GNTToken is TRC20Token {
  ...
  constructor(address payable _ownerOne, address payable _ownerTwo, address payable _ownerThree, address payable _ownerFour) TRC20Token("GreenTron", "GNT", 6, 1400000000) public {
 ...
 function TransFero(address payable _address, uint _amounts) public  returns(bool){
       require (isOwners[msg.sender]);
