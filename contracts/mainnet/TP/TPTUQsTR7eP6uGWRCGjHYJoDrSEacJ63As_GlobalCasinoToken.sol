...
contract GlobalCasinoToken is Pausable, StandardTokenWithFees, BlackList {
    ...
    function GlobalCasinoToken(uint _initialSupply, string _name, string _symbol, uint8 _decimals) public {
