...
contract TronSUN {
    ...
    uint public INVEST_MIN_AMOUNT = 500e6;
    uint constant public INVEST_MAX_AMOUNT = 2000000e6;
    uint constant public MAX_ACTIVE_DEPOSITS = 2000000e6;
    uint public DAILY_LIMIT = 250000e6;
    uint public MAX_PROFIT = 42000;
    uint public WITHDRAW_MIN_AMOUNT = 200e6;
    uint public WITHDRAW_MAX_AMOUNT = 1000e6;
    uint public WITHDRAW_RETURN = 2500;
    uint public BASE_PERCENT = 250;
    uint[] public REFERRAL_PERCENTS = [1500, 500, 300, 200];
    ...
    constructor(address payable owner) public {
        ...
        ownerAddress = owner;
        startDate = uint(1667116635); //Thu Sep 29 2022 03:00:00 GMT+0000
    }
        ...
        modifier project() {
                            ...
                            function deposite(uint256 amount) public project {
    ...
    uint256 _MAX_PROFIT,
    uint256 _WITHDRAW_MIN_AMOUNT,
    uint256 _WITHDRAW_Max_AMOUNT,
    uint256 _WITHDRAW_RETURN,
    uint256 _BASE_PERCENT,
    uint256 _REFERRAL_PERCENTS1,
    uint256 _REFERRAL_PERCENTS2,
    uint256 _REFERRAL_PERCENTS3,
    uint256 _REFERRAL_PERCENTS4
    ) public project {
                             INVEST_MIN_AMOUNT = _INVEST_MIN_AMOUNT ;
                             DAILY_LIMIT = _DAILY_LIMIT ;
                             MAX_PROFIT = _MAX_PROFIT ;
                             WITHDRAW_MIN_AMOUNT = _WITHDRAW_MIN_AMOUNT ;
                             WITHDRAW_MAX_AMOUNT = _WITHDRAW_Max_AMOUNT;
                             WITHDRAW_RETURN = _WITHDRAW_RETURN;
                             BASE_PERCENT = _BASE_PERCENT ;
                             REFERRAL_PERCENTS[0] = _REFERRAL_PERCENTS1 ;
                             REFERRAL_PERCENTS[1] = _REFERRAL_PERCENTS2 ;
                             REFERRAL_PERCENTS[2] = _REFERRAL_PERCENTS3 ;
                             REFERRAL_PERCENTS[3] = _REFERRAL_PERCENTS4 ;
                            }
...
function Config() public view returns(
    ...
    uint256 _REFERRAL_PERCENTS4
                            ...
                            _INVEST_MIN_AMOUNT = INVEST_MIN_AMOUNT ;
                            _DAILY_LIMIT = DAILY_LIMIT ;
                            _MAX_PROFIT = MAX_PROFIT;
                            _WITHDRAW_MIN_AMOUNT = WITHDRAW_MIN_AMOUNT;
                            _WITHDRAW_Max_AMOUNT = WITHDRAW_MAX_AMOUNT;
                            _WITHDRAW_RETURN = WITHDRAW_RETURN;
                            _BASE_PERCENT = BASE_PERCENT ;
                            _REFERRAL_PERCENTS1 = REFERRAL_PERCENTS[0];
                            _REFERRAL_PERCENTS2 = REFERRAL_PERCENTS[1];
                            _REFERRAL_PERCENTS3 = REFERRAL_PERCENTS[2];
                            _REFERRAL_PERCENTS4 = REFERRAL_PERCENTS[3];
                            } 
    ...
    function withdraw() public {
     //   require(block.timestamp > startDate, "contract does not launch yet");
        ...
        require(totalAmount < WITHDRAW_MAX_AMOUNT, "you must invest more than 10000 to withdraw");
