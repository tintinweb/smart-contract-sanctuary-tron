...
=== 'OrigoFinance' contract with following features ===
    => TRC20 Compliance
...
-------------------------------------------------------------------
 Copyright (c) 2022 onwards OrigoFinance
-------------------------------------------------------------------
*/ 
...
contract OrigoFinance is owned {
    
    using SafeMath for uint256;

    string constant private _name = "OrigoFinance";
    string constant private _symbol = "OFC";
    uint256 constant private _decimals = 8;
    uint256 private _totalSupply;                       
    uint256 private maxSupply = 500000000 * (10**_decimals);
