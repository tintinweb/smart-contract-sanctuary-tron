...
contract TrxRewards {
    ...
    constructor() public {
        ...
        tarifs.push(Tarif(100, 50)); // Will be multiplied by 4 due to uint8 limitations
        tarifs.push(Tarif(100, 90));
    ...
    function _payout(address _addr) private {
        ...
        payout=payout*4/5;  //80% payout after withdrawal 20% autoreinvest
        ...
        for(uint256 i = 0; i < player.deposits.length; i++) {
            ...
            if(from < to) {
                    ...
                    if(player.total_invested>=10000e7){
                        value += dep.amount * (to - from) * 25 * 4 / tarif.life_days / 8640000; // (95+25)*4/100= 4.8%
                    }
            }
        }
