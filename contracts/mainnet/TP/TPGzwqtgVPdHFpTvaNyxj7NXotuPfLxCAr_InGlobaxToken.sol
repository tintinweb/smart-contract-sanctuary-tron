 ...
 */
contract InGlobaxToken is Context, AccessControl, TRC20Burnable{
     ...
     */
    constructor() public TRC20("InGlobax", "IGX") {
        _setupRole(DEFAULT_ADMIN_ROLE, _msgSender());



        _mint(_msgSender(), 1000000000*10**6);
    }
