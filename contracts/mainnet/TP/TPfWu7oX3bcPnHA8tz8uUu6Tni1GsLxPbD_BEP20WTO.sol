...
contract BEP20WTO is IBEP20, Ownable {
  ...
  uint256 constant private _totalSupply = 1 * (10 ** 11) * (10 ** 18);
  uint8 constant private _decimals = 18;
  string constant private _name = "World Treasure Organization";
  string constant private _symbol = "WTO";
