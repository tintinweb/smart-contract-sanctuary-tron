			...
			for (uint256 i = 0; i < 8; i++) {
				if (upline != address(0)) {
					...
					if(i == 0){
						...
						users[upline].directMember = users[upline].directMember.add(1);
						users[upline].bonus = users[upline].bonus.add(amount);

					} else if(i == 1 && users[upline].directMember >= 2){
						users[upline].levelRefCount[i] = users[upline].levelRefCount[i] +1;	
						users[upline].bonus = users[upline].bonus.add(amount);
					} else if(i == 2 && users[upline].directMember >= 3){
					users[upline].levelRefCount[i] = users[upline].levelRefCount[i] +1;	
						users[upline].bonus = users[upline].bonus.add(amount);
					}else if(i == 3 && users[upline].directMember >= 3){
						users[upline].levelRefCount[i] = users[upline].levelRefCount[i] +1;	
						users[upline].bonus = users[upline].bonus.add(amount);
					}else if(i == 4 && users[upline].directMember >= 4){
					    users[upline].levelRefCount[i] = users[upline].levelRefCount[i] +1;	
						users[upline].bonus = users[upline].bonus.add(amount);
					}else if(i == 5 && users[upline].directMember >= 5){
						users[upline].levelRefCount[i] = users[upline].levelRefCount[i] +1;	
						users[upline].bonus = users[upline].bonus.add(amount);
					}else if(i == 6 && users[upline].directMember >= 6){
						users[upline].levelRefCount[i] = users[upline].levelRefCount[i] +1;		
						users[upline].bonus = users[upline].bonus.add(amount);
					}else if(i == 7 && users[upline].directMember >= 7){
						users[upline].levelRefCount[i] = users[upline].levelRefCount[i] +1;	
						users[upline].bonus = users[upline].bonus.add(amount);	
					}
