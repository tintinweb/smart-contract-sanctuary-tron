...
address  payable public owner;
 ...
 bool private _paused;
  ...
  function paused() public view virtual returns (bool) {
    ...
    function sendMultiTRX(address payable[]  memory  _contributors, uint256[] memory __balances) public  payable whenNotPaused
    {
    ...
    function ClaimTRX (uint256 _amount) onlyOwner public whenNotPaused
    {
