...
contract VedicToken is TRC20 , Context , Ownable{
    ...
    constructor() {
        ...
        _symbol = "VTN";
        _decimals = 8;
        _mint(msg.sender, 2000000000000 * 8**_decimals);
        ...
        maxBuyAmountPerDay = 20000 * 10**_decimals;
        maxBuyAmountPerTxn = 2000 * 10**_decimals;    
