...
contract ALPHABITCOIN  is owned {
    ...
    string constant private _name = "ALPHABITCOIN";
    string constant private _symbol = "ABTCN";
    uint256 constant private _decimals = 8;
    uint256 private _totalSupply;
    uint256 constant public maxSupply = 210000000 * (10**_decimals);    //1 billion tokens
    uint constant private _preMine =  210000000 * (10**_decimals);       // 1 billion token for deployer 
