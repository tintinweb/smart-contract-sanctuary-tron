 ...
 * `TRC20` functions.
 */
contract RUNICN is TRC20, TRC20Detailed {

    /**
     * @dev Constructor that gives msg.sender all of existing tokens.
     */
    constructor () public TRC20Detailed("RUNICN", "RUNICN", 6) {
        _mint(msg.sender, 36900000000 * (10 ** uint256(decimals())));
    }
}
