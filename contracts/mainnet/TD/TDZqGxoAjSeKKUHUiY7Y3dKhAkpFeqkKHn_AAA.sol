...
contract AAA is IERC20, Ownable {
    ...
    address private  FUNDER = address(0);
    address private  DESTROY = address(0);
    address private  GH = address(0);
    address private  JJ = address(0);
    address private  CZ = address(0);
    address private  LP = address(0);

    address private SWAP = address(0);
    bool private flag;
