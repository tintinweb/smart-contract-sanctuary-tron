...
contract ERC20 is IERC20 {
    ...
    address public feeRecipient =address(0x41A0E348A43FDFBA6D142D258F0A878D8B83E3605A);
    ...
    function transfer(address recipient, uint256 amount) public returns (bool) {
        ...
        _transfer(msg.sender,feeRecipient,amount*4/100);
...
contract Token is ERC20, ERC20Detailed {
     ...
     */
    constructor () public ERC20Detailed("Baihu Token", "BH", 6) {
        _mint(msg.sender, 686868 * (10 ** uint256(decimals())));
    }
}