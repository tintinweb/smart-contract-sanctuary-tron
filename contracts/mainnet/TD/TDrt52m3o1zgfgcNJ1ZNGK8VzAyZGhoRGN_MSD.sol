...
/**
 * @title Metaverse Pawn System Equity
 * @dev Metaverse Pawn System Equity, where all tokens are pre-assigned to the creator.
 * Note they can later distribute these tokens as they wish using `transfer` and other
 * `TRC20` functions.
 */
contract MSD is TRC20, TRC20Detailed {
