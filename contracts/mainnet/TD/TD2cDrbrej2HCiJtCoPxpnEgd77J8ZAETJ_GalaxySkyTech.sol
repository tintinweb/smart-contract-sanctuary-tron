//SourceUnit: GalaxySkyTechJoiningContract.sol
...
contract GalaxySkyTech {
    ...
    constructor(address _primaryAdmin,address _joiningToken) public {
        primaryAdmin = _primaryAdmin;
        joiningToken = ITRC20(_joiningToken);
    }
