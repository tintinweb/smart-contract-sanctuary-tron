...
contract Common is TRC20Detailed{
    ...
    uint internal exchange_fee_ratio_in = 4;

    uint internal exchange_fee_ratio_out = 4;
...
contract TRC20 is ITRC20, Common {
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal {
        ...
        if (exchangeInAddressList[sender] && !canBuyAll) {
            require(whiteAddressList[recipient], "TRC20: only can buy with whiteaddress");
        }
