...
/**
 * @title WineEstate
 * @dev TRC20 Token WineEstate, where all tokens are pre-assigned to the creator.
 * Note they can later distribute these tokens as they wish using `transfer` and other
 * `TRC20` functions.
 */
contract WineEstate is TRC20, TRC20Detailed, Ownable {
