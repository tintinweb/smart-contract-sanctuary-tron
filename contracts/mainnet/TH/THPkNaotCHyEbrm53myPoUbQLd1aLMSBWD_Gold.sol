...
contract Gold is TRC20 {
    ...
    function tweakDailyDividends(uint256 newResearchPercent, uint256 newGoldDepositPercent) external {
        require(msg.sender == owner);
        require(newResearchPercent > 0 && newResearchPercent <= 1000);
        require(newGoldDepositPercent > 0 && newGoldDepositPercent <= 1000);
    ...
    function snapshotDailyGoldResearchFunding() public {
        ...
        uint256 todaysGoldResearchFund = (totalTronGoldResearchPool * researchDivPercent) / 1000; // % of pool daily
    ...
    function snapshotDailyGoldDepositFunding() public {
        ...
        uint256 todaysGoldDepositFund = (totalTronGoldResearchPool * goldDepositDivPercent) / 1000; // % of pool daily
