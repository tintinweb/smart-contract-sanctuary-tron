...
contract Tron2getvip {
	...
	uint256[] public REFERRAL_PERCENTS = [120, 60, 20];
	uint256 constant public MARKETING_FEE = 240;
	uint256 constant public PROJECT_FEE = 60;
	uint256 constant public PERCENTS_DIVIDER = 1000;
	uint256 constant public CONTRACT_BALANCE_STEP = 750000 trx;  // If reach 750K TRX, contract ROI will increase by 0.1% everyday
