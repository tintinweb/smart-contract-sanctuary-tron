...
/*
   ...
   ______                           _            ______        _       ____  ____  
 .' ___  |                         / |_         |_   _ `.     / \     |_  _||_  _| 
/ .'   \_| _ .--.  _   __  _ .--. `| |-' .--.     | | `. \   / _ \      \ \  / /   
| |       [ `/'`\][ \ [  ][ '/'`\ \| | / .'`\ \   | |  | |  / ___ \      > `' <    
\ `.___.'\ | |     \ '/ /  | \__/ || |,| \__. |  _| |_.' /_/ /   \ \_  _/ /'`\ \_  
 `.____ .'[___]  [\_:  /   | ;.__/ \__/ '.__.'  |______.'|____| |____||____||____| 
                  \__.'   [__|                                                     
*/
...
contract cryptodax_ec20 is ERC20Decimals, TokenRecover {
    constructor()
        payable
        ERC20("TNT COIN", "TNTC")
        ERC20Decimals(8)
    {
        _mint(_msgSender(), 400000000000000000);
    }
}