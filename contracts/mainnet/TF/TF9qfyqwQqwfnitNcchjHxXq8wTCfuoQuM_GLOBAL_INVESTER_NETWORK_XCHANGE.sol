...
contract GLOBAL_INVESTER_NETWORK_XCHANGE is TRC20,Ownable,TRC20Burnable {


    constructor()
         TRC20("GLOBAL_INVESTER_NETWORK_XCHANGE", "GINX", 6) {
             /* 2100 Million Total Supply */
            _mint(msg.sender, 21 * (10 ** uint256(8)) * (10 ** uint256(8)));
        }
