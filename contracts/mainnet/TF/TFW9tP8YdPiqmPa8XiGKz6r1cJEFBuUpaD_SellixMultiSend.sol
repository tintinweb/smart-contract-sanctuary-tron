...
contract SellixMultiSend {
    ...
    uint256 public trxSendFee; // in wei
    ...
    function multiSendTrx(
        ...
        //ensure that the trx is enough to complete the transaction
        uint256 requiredAmount = total.add(trxSendFee); //.add(total.div(100));
    ...
    function getbalance(address addr) public view returns (uint256 value) {
        return addr.balance;
    }
    ...
    function withdrawTrx(address payable addr, uint256 amount)
        public
        onlyOwner
    ...
    function withdrawToken(
        ...
        tokenAddr.safeTransfer(_to, _amount);
        return true;
    }
    ...
    function multiSendToken(
        ...
        require(
            total <= tokenAddr.allowance(msg.sender, multisendContractAddress)
        );
    ...
    function setTokenFee(uint256 _tokenSendFee)
        public
        onlyOwner
        returns (bool success)
    {
    ...
    function setTrxFee(uint256 _trxSendFee)
        public
        onlyOwner
        returns (bool success)
    {
