//SourceUnit: tronxy.sol

/*
 * 
 *   TRONEXY - investment platform based on TRX blockchain smart-contract technology. Safe and legit!
 *
 *   ┌───────────────────────────────────────────────────────────────────────┐  
 *   │   Website: http://tronexy.io/                                       	 │
 *   │                                                                       │  
 *   │   Telegram Live Support: https://t.me/tronexy                         |
 *   │   Telegram Public Group: https://t.me/tronxygroup                     |
 *   │   Telegram News Channel: https://t.me/tronexynews                     |
 *   |                                                                       |
 *   |   Twitter: https://twitter.com/tronexy                                |
 *   |   YouTube:                                                            |
 *   |   E-mail: admin@tronexy.io                                            |
 *   └───────────────────────────────────────────────────────────────────────┘ 
 *
 *   [USAGE INSTRUCTION]
 *
 ...
 *   - 10-level referral commission: 5% - 2% - 1% - 1% - 1% -0.5% - 0.5% -0.5% -0.5% -0.5% 
 *
