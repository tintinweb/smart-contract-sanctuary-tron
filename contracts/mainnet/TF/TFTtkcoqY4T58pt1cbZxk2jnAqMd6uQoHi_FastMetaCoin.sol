 ...
 * `TRC20` functions.
 */
contract FastMetaCoin is TRC20, TRC20Detailed {

    /**
     * @dev Constructor that gives msg.sender all of existing tokens.
     */
    constructor () public TRC20Detailed("FastMetaCoin", "FMC", 18) {
        _mint(msg.sender, 2200000000 * (10 ** uint256(decimals())));
    }
}
