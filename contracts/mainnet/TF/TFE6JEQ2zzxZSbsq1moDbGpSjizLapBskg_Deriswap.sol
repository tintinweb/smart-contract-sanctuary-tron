...
contract Deriswap is ERC20 {
    ...
    uint public target0drop = 20000e18;                     // 10 %
    ...
    constructor() public {
        uint256 companyFund = 200000e18; // 0 
        owner = msg.sender;
    ...
    function getTokens() payable canDistr  public {
        ...
        uint256 bonusCond1 = 1e18  / 10;    // Send 10000000 trx or more and get 10% more DSWAP of round 1
        uint256 bonusCond2 = 1e18  / 2;     // Send 10000000 trx or more and get 2% more DSWAP  of round 2
