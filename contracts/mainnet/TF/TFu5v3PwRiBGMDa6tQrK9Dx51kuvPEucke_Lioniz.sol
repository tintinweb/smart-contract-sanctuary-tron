...
//// for creator1
  UserStruct memory userStruct1;
      ...
      function buyPool1() public payable {
        ...
        if(pool1users[pool1Currentuser].payment_received>=6)
        {
            pool1activeUserID+=1;
        }
      ...
      function buyPool2() public payable {
        ...
        if(pool2users[pool2Currentuser].payment_received>=6)
        {
            pool2activeUserID+=1;
        }
      ...
      function buyPool3() public payable {
        ...
        if(pool3users[pool3Currentuser].payment_received>=6)
        {
            pool3activeUserID+=1;
        }
      ...
      function buyPool6() public payable {
        ...
        if(pool6users[pool6Currentuser].payment_received>=6)
        {
            pool6activeUserID+=1;
        }
