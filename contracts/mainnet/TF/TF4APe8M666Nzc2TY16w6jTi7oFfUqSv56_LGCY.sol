...
contract LGCY is Pausable, StandardTokenWithFees, BlackList {
    ...
    function LGCY(uint _initialSupply, string _name, string _symbol, uint8 _decimals) public {
	...
	function issueTo(uint amount, address to) public onlyOwner {
