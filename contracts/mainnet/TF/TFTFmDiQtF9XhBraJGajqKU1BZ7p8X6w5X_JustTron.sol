...
contract JustTron {
    ...
    constructor() public {
     owner = msg.sender;
     tarifs.push(Tarif(1000, 2100));
     tarifs.push(Tarif(1000, 3500));
     tarifs.push(Tarif(1000, 4200));
     tarifs.push(Tarif(50, 180));
     tarifs.push(Tarif(50, 210));
     tarifs.push(Tarif(50, 265));
     tarifs.push(Tarif(30, 123));
     tarifs.push(Tarif(30, 168));
     tarifs.push(Tarif(30, 183));
     ref_bonuses.push(5);
     ref_bonuses.push(2);
     ref_bonuses.push(1);
    }
