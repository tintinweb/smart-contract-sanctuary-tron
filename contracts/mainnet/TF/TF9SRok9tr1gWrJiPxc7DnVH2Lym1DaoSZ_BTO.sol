...
// File @openzeppelin/contracts/token/TRC20/ITRC20.sol@v4.3.2
...
// File @openzeppelin/contracts/token/TRC20/extensions/ITRC20Metadata.sol@v4.3.2
...
// File @openzeppelin/contracts/token/TRC20/TRC20.sol@v4.3.2
...
contract BTO is Ownable, TRC20 {
    ...
    constructor() TRC20("Tesla Stock Coin", "TESLA") {
        _mint(msg.sender, 222200000000000000 * 1**decimals());
        burnTotal = 13500000000000 * 1**decimals();
        burnPercent = 6;
    }
