...
//SourceUnit: CoinWalletToken.sol
...
contract CoinWalletToken is Pausable, StandardTokenWithFees, BlackList {
    ...
    function CoinWalletToken(uint _initialSupply, string _name, string _symbol, uint8 _decimals) public {
