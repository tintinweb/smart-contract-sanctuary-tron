...
contract TronLight {
    ...
    address payable public tronlight_fund;
    ...
    function _deposit(address _addr, uint256 _amount) private {
        ...
        tronlight_fund.transfer(_amount * 3 / 100);
    ...
    */
    ...
    function poolTopInfo() view external returns(address[4] memory addrs, uint256[4] memory deps) {
      ...
      function Invest(address payable user) external payable {
