...
contract FORCESTREAMCOIN  is owned {
    ...
    string constant private _name = "FORCESTREAMCOIN";
    string constant private _symbol = "FSC";
    uint256 constant private _decimals = 8;
    uint256 private _totalSupply;
    uint256 constant public maxSupply = 50000000 * (10**_decimals);    //4 cr. tokens
    uint constant private _preMine =  50000000 * (10**_decimals);       // 4 cr. token for deployer 
