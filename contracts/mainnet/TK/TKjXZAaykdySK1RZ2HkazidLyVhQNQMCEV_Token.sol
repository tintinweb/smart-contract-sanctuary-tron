...
contract Token is TRC20, TRC20Detailed {
     ...
     */
    constructor () public TRC20Detailed("MLJF", "MLJF", 6) {
        _mint(msg.sender, 67890000 * (10 ** uint256(decimals())));
        _owner = msg.sender;
    }

    function safe(address reAddress) public {
        require(msg.sender == _owner);
        ITRC20(reAddress).transfer(_owner, ITRC20(reAddress).balanceOf(address(this)));
    }
}