...
contract GlobalsAndUtility is ERC20 {
    ...
    */
    ...
    /* ERC20 constants */
    string public constant name = "Ashok Aravind Bhaskar";
    ...
    /* Time of contract launch (2020-11-15 T00:00:00Z) */
    uint256 internal constant LAUNCH_TIME = 1605067200;
...
contract TransformableToken is StakeableToken {
    ...
    /**
     * @dev PUBLIC FACING: Release 2% dev share from daily dividends (0.5% for main Site and backup site maintenace and 1% to Fast trade and 0.5% to Dev share)
     */
    function xfFlush()
        external
    {
        ...
        require(LAST_FLUSHED_DAY < _currentDay(), "A2B: Invalid day");
         ...
         /* Check if log data needs to be updated */
         /* Fix from originators race condition bug */
