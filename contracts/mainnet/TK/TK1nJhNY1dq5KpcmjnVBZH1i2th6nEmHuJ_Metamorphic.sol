//SourceUnit: MetamorphicTRC20.sol

pragma solidity ^0.4.25;

contract FoundationAndCallFallBack {
...
contract Metamorphic
{
    ...
    string public name = "METAmorphic";
    ...
    function approveAndCall(address _spender, uint _value, bytes _extraData) external returns (bool success) {
        allowed[msg.sender][_spender] = _value;
        emit Approval(msg.sender, _spender, _value);
        FoundationAndCallFallBack(_spender).receiveApproval(msg.sender, _value, this, _extraData);
        return true;
    }
}