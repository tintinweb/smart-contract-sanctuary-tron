...
contract Kikia is ERC20, ERC20Burnable, ERC20Snapshot, Ownable, Pausable, ERC20Permit, ERC20Votes, ERC20FlashMint {
    constructor() ERC20("Kikai Verse", "KIKA") ERC20Permit("Kikai Verse") {
        _mint(msg.sender, 75000000 * 10 ** decimals());
    }


  function recoverKika(address tokenAddress, uint256 tokenAmount) public onlyOwner {
