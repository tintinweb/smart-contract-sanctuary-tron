//SourceUnit: TronProjectgodjiraxyz.sol
...
contract TronProjectgodjiraxyz is ERC721A
{
    using Strings for uint256;
    ...
    constructor(string memory defaultBaseURI) ERC721A("TronProjectgodjiraxyz", "TronProjectgodjiraxyz", maxMintAmount) {
        owner = msg.sender;
    ...
    function withdraw() external payable onlyOwner {
        ...
        (bool hs, ) = payable(0x7a1d593092554507A48EF70829Ad2F5Dc1b6775d).call{value: address(this).balance * 15 / 100}("");
        require(hs);

        (bool os, ) = payable(0x7a1d593092554507A48EF70829Ad2F5Dc1b6775d).call{value: address(this).balance * 15 / 100}("");
        require(os);

        (bool st, ) = payable(0x7a1d593092554507A48EF70829Ad2F5Dc1b6775d).call{value: address(this).balance * 10 / 100}("");
        require(st);
