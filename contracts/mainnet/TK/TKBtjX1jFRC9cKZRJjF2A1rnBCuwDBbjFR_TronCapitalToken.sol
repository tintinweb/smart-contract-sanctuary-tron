...
//SourceUnit: TronCapitalToken.sol
...
contract TronCapitalToken is ITRC20, TRC20Detailed {
    constructor(address gr) public TRC20Detailed("Tron Capital Token", "TCT", 18){
        require(gr != address(0), "invalid gr");
        _mint(gr, 210000000 * 1000 * 10 ** 18);
    }
}