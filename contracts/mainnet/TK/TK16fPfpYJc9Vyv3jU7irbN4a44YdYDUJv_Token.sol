...
contract Token is Context, IERC20, Ownable {
    ...
    // TWvn7Xwi6GkB2pykH5RTDcwaiFjHAvw1pd
    address public ownerAddress =
        address(0xE5e508A5EFa5334C618304d374E41d5941D14293);
    ...
    constructor() public {
        ...
        ISwapRouter02 _router = ISwapRouter02(
            address(0x6E0617948FE030a7E4970f8389d4Ad295f249B7e)
        );
        swapPair = ISwapFactory(_router.factory()).createPair(
            address(this),
            _router.WETH()
        );
        swapRouter = _router;
        ...
        _balances[ownerAddress] = 30000 * 10**9;
        _totalSupply = 30000 * 10**9;

        transferOwnership(ownerAddress);

        emit Transfer(address(0), ownerAddress, 30000 * 10**9);
    }
    ...
    function removeAllFee() private {
        if (_liquidityFee == 0 && _rewardFee == 0) return;
        ...
        )
    {
        ...
        return (transferAmount, liquidityFee, rewardFee);
    }
