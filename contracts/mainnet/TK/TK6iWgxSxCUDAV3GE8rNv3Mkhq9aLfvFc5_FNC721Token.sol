...
library Address {
    ...
    /**
     * @dev Checks if a contract is placed on a specific address.
     * The assembly language that all Ethereum contracts compile down to contains an opcode for this precise operation: 
     * EXTCODESIZE. This opcode returns the size of the code on an address. If the size is larger than zero, 
     * the address is a contract.
     *
     * NOTE: But anyone using this solution should also know that it's possible for a contract to return 0 from 
     * EXTCODESIZE if the function call was made from within that contracts constructor.
     * https://ethereum.stackexchange.com/questions/15641/how-does-a-contract-find-out-if-another-address-is-a-contract
     *
     * Also, to safeguard against possible subvertion via call from constructor; see
     * https://ethereum.stackexchange.com/questions/14015/iscontract-function-using-evm-assembly-to-get-the-address-code-size/14016#14016
     *
     * _Available since _
     */
...
contract FNC721Token is TRC721, TRC721Enumerable, TRC721MetadataMintable {
    constructor() public TRC721Metadata("FanCoin NFT", "FNCNFT") {
...
contract TRC721 is Context, TRC165, ITRC721 {
    ...
    {
        if (to != tx.origin) {   // changed from !to.isContract
            return true;
        }
...
//SourceUnit: TRC721MetadataMintable.sol
