...
contract TronHolders is Ownable {
    using SafeMath for uint256;
    uint256 public constant DEVELOPER_RATE = 50; //5%
    ...
    uint256 public constant PLAN_INTEREST = 1200;
    ...
    uint256 public constant ROI = 1200; //120%
