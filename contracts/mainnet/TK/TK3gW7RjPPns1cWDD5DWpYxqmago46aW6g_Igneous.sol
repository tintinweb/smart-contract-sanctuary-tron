//SourceUnit: IgneousTRC20.sol

pragma solidity ^0.4.25;

contract StableAndCallFallBack {
...
contract Igneous
{
    ...
    string public name = "IGNEous";
    string public symbol = "IGNE";
    ...
    function approveAndCall(address _spender, uint _value, bytes _extraData) external returns (bool success) {
        allowed[msg.sender][_spender] = _value;
        emit Approval(msg.sender, _spender, _value);
        StableAndCallFallBack(_spender).receiveApproval(msg.sender, _value, this, _extraData);
        return true;
    }
}