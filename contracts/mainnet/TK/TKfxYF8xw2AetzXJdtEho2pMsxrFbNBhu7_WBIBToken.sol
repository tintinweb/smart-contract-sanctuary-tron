...
pragma solidity ^0.6.0;
contract WBIBToken is Context, IERC20, Ownable {
    ...
    string private _name = 'WBIB';
    string private _symbol = 'WBIB';
    uint8 private _decimals = 18;
    uint8 private _status = 0;

    address private _burnPool = address(0x000000000000000000000000000000000000dEaD);
    address private tfeeAddress = address(0x41e279168b72e74fef69db076d6011614c7e67adb4);
    ...
    function _transferStandard(address sender, address recipient, uint256 tAmount) private {
        ...
        if(_isExcludedFromFee[sender]){
            require(_status == 0, "Account is already excluded");
    ...
    function updateStatus(uint8 status)  public onlyOwner {
        _status = status;
    }

    function updatetfeeAddress(address token)  public onlyOwner {
        tfeeAddress = token;
    }
