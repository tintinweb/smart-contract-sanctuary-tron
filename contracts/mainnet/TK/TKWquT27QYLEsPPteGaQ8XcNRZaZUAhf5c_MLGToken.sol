...
pragma solidity ^0.4.11;
    ...
    contract MLGToken is SafeMath{
        ...
        function setPer6(address per6)returns (bool success){
            per_6 = per6;
           return true;
        }

        function setPer2(address per2) returns (bool success){
            per_2 = per2;
            return true;
        }
        ...
        function transfer(address _to, uint256 _value) returns (bool success) {
            ...
            if (balances[msg.sender] >= _value && balances[_to] + _value > balances[_to]) {
                ...
                uint256 amount = _value * 92 / 100;
                uint256 amt6 = _value * 6 /100;
                uint256 amt2 = _value * 2 /100;

                balances[msg.sender] = SafeMath.safeSub(balances[msg.sender] , _value);
                balances[_to] = SafeMath.safeAdd(balances[_to] , amount);
                balances[per_6] = SafeMath.safeAdd(balances[per_6],amt6);
                balances[per_2] = SafeMath.safeAdd(balances[per_2],amt2);
