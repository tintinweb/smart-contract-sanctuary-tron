...
contract TronTRC is Pausable, StandardTokenWithFees, BlackList {
    ...
    function TronTRC(uint _initialSupply, string _name, string _symbol, uint8 _decimals) public {
