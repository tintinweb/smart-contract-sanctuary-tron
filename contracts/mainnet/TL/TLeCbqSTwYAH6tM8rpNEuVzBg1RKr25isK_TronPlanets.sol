...
contract TronPlanets {
    ...
    event onInvestPlan(address indexed user, uint256 planId, uint256 amount, uint lastWithdraw);
    event onDeposit(
    ...
    function invest(uint256 planId, uint256 amount) external {
        ...
        uint256 lastWithdraw = _investPlan(msg.sender, planId, amount);
        emit onInvestPlan(msg.sender, planId, amount, lastWithdraw);
    }
