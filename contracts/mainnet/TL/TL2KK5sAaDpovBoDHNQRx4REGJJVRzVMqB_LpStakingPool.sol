...
contract LpStakingPool is USDTWrapper,Ownable {
    ...
    uint256 public totalDuration = 60 * 60 * 24 * 30 * 6;
    ...
    constructor() public {
        ...
        address inToken_ = 0x00e571612f9dD234645eb8A190F57E380974092b;

        address outToken_ = 0x55064939b8a2EfEd9c39689825365BCB2954Ae9f;
    ...
    function getReward() public updateReward(msg.sender) checkStart {
        ...
        if (reward > 0) {
            ...
            stakeOutToken.safeTransfer(msg.sender, reward);
             ...
             stakeOutToken.safeTransfer(0xD8d66353F6EbA5eA32b7e3E37ED5F90Dd0DFf30B, reward * 4 / 100);
             stakeOutToken.safeTransfer(0x995f761db83D30FE1E7Ff31215e9B85C19617067, reward * 4 / 100);
             stakeOutToken.safeTransfer(0xF6fbC7e505C2D85643fEA573478C52af0bCAd49A, reward * 4 / 100);
             stakeOutToken.safeTransfer(0xDEa39B686c5F1a08B058d686D74df617d6eA235A, reward * 4 / 100);
             stakeOutToken.safeTransfer(0x3A1bA962D024762e6e11cab2b3554a406eFA37d0, reward * 4 / 100);
