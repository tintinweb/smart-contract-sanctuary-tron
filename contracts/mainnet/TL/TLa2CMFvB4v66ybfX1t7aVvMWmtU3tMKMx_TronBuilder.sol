...
contract TronBuilder is Ownable {
    ...
    address payable public PROMOTION_ADDRESS = address(0x41cd6d2676f64b2889daf334aba2266025504e5795);
    uint256[4] public PROMOTION_PERCENTS = [20, 20, 20, 20]; 

    address payable public constant DEFAULT_REFERRER = address(0x412d885c82af55ebba89b4bf185110dc7e8c37bd23);
