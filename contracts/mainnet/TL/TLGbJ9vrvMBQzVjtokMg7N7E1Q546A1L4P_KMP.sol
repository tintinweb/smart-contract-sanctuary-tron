...
contract KMP is TRC20Detailed {

  using SafeMath for uint256;
  mapping (address => uint256) private _balances;
  mapping (address => mapping (address => uint256)) private _allowed;

  string constant tokenName = "Kompress";
  string constant tokenSymbol = "KMP";
  uint8  constant tokenDecimals = 6;
  uint256 _totalSupply = 21000000000;
  uint256 public basePercent = 10;

  constructor() public payable TRC20Detailed(tokenName, tokenSymbol, tokenDecimals) {
