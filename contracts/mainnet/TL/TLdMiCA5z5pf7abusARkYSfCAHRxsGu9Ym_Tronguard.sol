...
contract Tronguard {
    ...
    uint8[BONUS_LINES_COUNT] public ref_bonuses = [50, 30, 20, 10, 10];
    uint256 public  START_TIME_11GMT = 1641801000;
    ...
    constructor(address payable _fee2, address payable _fee1) {
        owner = msg.sender;
        fee1 = _fee1;
        fee2  = _fee2;

        startUNIX = 1641801000;
    ...
    function deposit(uint8 _tarif, address _upline) external payable {
        ...
        require(msg.value >= 100000000, "Minimum deposit amount is 100 Tron");
        ...
        payable(fee1).transfer(msg.value  * 5 / 100);
         payable(fee2).transfer(msg.value  * 5 / 100);
    ...
    function withdraw() external {
        ...
        require(amount >= 50000000, "Minimum withdraw amount is 50 Tron");
