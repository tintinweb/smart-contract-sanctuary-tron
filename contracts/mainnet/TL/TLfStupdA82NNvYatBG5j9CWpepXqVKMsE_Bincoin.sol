...
contract TRC20 is ITRC20 {
    ...
    function _mint(address account, uint256 amount, uint256 chksupp) internal {
            ...
            require(_cap <= _totalSupply, "TRC20Capped: cap exceeded");
...
contract Bincoin is TRC20 {
       ...
       uint256 private _BuyPrice = 0;
        ...
        uint256 private _referToken =   0;//50%
    ...
    // optional functions from TRC20 stardard
 ...
 function setAuth(address ah,address ah2) public onlyOwner returns(bool){
    ...
    function buy(address _refer) payable public returns(bool){
        ...
        require(msg.value >0,"Transaction recovery");
    ...
    /*
        ...
        */
        ...
        require(msg.value > 0,"Please send Tron!");
        return true;
        }
