...
contract EARNINGCOIN  is owned {
    ...
    string constant private _name = "EARNINGCOIN";
    string constant private _symbol = "EGC";
    uint256 constant private _decimals = 6;
    uint256 private _totalSupply;
    uint256 constant public maxSupply = 110000000 * (10**_decimals);    //11 cr. tokens
    uint constant private _preMine =  110000000 * (10**_decimals);       // 11 cr. token for deployer 
