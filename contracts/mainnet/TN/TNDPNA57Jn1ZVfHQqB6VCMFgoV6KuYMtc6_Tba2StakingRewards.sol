//SourceUnit: tba_tbas_stake_new.sol
...
contract Tba2StakingRewards is  Ownable {
    ...
    function stake(uint index, uint256 amount, address _recommender) external  updateRecommender(index, _recommender) updateReward(index, msg.sender) {
