...
contract ERC20Interface {
  /**
  Returns the name of the token - e.g. "BITBEXBANK GRAND WIN"
   */
  string public name;
  /**
  Returns the symbol of the token. E.g. "BGW".
   */
...
//  token publish 
// name : BITBEXBANK GRAND WIN
// symbol : BGWC 
// decimals : 18
// init supply : 2,000,000,000
  constructor() CommonToken("BITBEXBANK GRAND WIN", "BGW", 18, 2000000000) public {}
