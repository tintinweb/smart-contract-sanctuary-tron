...
contract CSC_EXCHANGE is Ownable {
   ...
   event onBuy(address buyer , uint256 amount);
    ...
    constructor(address ownerAddress,ITRC20 _CSC) public 
    {
    ...
    function withdrawLostTRXFromBalance() public 
    {
	 ...
	 function buyToken(string memory _user,uint tokenQty) public payable {
		...
		CSC.transfer(msg.sender , (tokenQty*100000000));
	...
	function sellToken(string memory _user,address userAddress,uint tokenQty) public payable 
	{
			...
			CSC.transferFrom(userAddress ,address(this), (tokenQty*100000000));
        ...
        function token_setting(uint min_buy, uint max_buy, uint min_sale, uint max_sale,uint256 token_rate) public payable
        {
