...
contract TBASToken is IERC20, Ownable {
    ...
    constructor(address _burnAddress, address _fundAddress, address _marketAddress) {
        _name = "TBAS";
        _symbol = "TBAS";
        _decimals = 18;
