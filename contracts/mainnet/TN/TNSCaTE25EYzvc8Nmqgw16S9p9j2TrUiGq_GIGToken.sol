 ...
 */
contract GIGToken is Context, AccessControl, TRC20Burnable{
     ...
     */
    constructor() public TRC20("GIG", "GIG") {
        _setupRole(DEFAULT_ADMIN_ROLE, _msgSender());

        _setupRole(MINTER_ROLE, _msgSender());

        _mint(_msgSender(), 1500000*10**6);
    }
    ...
    function mint(address to, uint256 amount) public virtual {
        require(hasRole(MINTER_ROLE, _msgSender()), "GIGToken: must have minter role to mint");
        _mint(to, amount);
    }
