...
contract RAMCOIN is ITRC20, TRC20Detailed {
    constructor(address ramcoinx) public TRC20Detailed("RAMCOIN", "RAM", 10){
        require(ramcoinx != address(0), "invalid ramcoinx");
        _mint(ramcoinx, 10000000 * 1000 * 10 ** 10);
    }
}
