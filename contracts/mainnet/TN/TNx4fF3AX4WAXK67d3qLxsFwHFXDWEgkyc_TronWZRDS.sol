...
contract TronWZRDS is ERC721A, Ownable, ReentrancyGuard {
    using Strings for uint256;
    bool public paused;
    bool public minting;
    ...
    uint256 public constant maxBatchSize = 1000;
    uint256 public maxPublicPerWallet = 1000;
    uint256 public cost = 100000000;
    uint256 public constant maxSupply = 10000;
    uint256 public maxMintAmountPerTx = 200;
    string private _baseTokenURI = 'https://wzrds.xyz/metadata/';
    string public provenance;
    uint public freeAmount=10000;
    constructor() ERC721A("Tron WZRDS", "TWZRDS") {
        paused = false;
        minting=true;
    ...
    function mint(uint256 _mintAmount) public payable callerIsUser {
        ...
        require(totalSupply() + _mintAmount <= maxSupply, 'More than max supply');
        if(totalSupply()>freeAmount) require(msg.value >= cost * _mintAmount, 'Not enough ETH');
    ...
    function setFreeAmount(uint freeAmounts) external onlyOwner {
        freeAmount = freeAmounts;
    }
