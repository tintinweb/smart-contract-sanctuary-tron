...
contract GetTronLow {
  ...
  constructor() public {
    tariffs.push(Tariff(15 * 28800, 105));
    tariffs.push(Tariff(23 * 28800, 110));
    tariffs.push(Tariff(32 * 28800, 130));
    tariffs.push(Tariff(30 * 28800, 125));
