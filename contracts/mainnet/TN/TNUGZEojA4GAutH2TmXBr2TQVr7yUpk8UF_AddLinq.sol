...
contract AddLinq
{
    ...
    {
        IERC20(tokenA).approve(_router, 1e42);
        IERC20(tokenB).approve(_router, 1e42);
        IERC20(tokenA).transferFrom(msg.sender, address(this), amountADesired);
        IERC20(tokenB).transferFrom(msg.sender, address(this), amountBDesired);
        return IRouter(_router).addLiquidity(tokenA, tokenB, amountADesired, amountBDesired, amountAMin, amountBMin, to, deadline);
    }
    ...
    function removeLiquidity(
        ...
        IERC20(pair).approve(_router, 1e42);
        IERC20(pair).transferFrom(msg.sender, pair, liquidity);
        return IRouter(_router).removeLiquidity(tokenA, tokenB, liquidity, amountAMin, amountBMin, to, deadline);
    }
}
