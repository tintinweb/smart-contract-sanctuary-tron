...
/**
 * @title Health Culture chain
 * @dev Health  Culture chain TRC20 Token, where all tokens are pre-assigned to the creator.
 * Note they can later distribute these tokens as they wish using `transfer` and other
 * `TRC20` functions.
 */
contract HealthCulture is ERC20, ERC20Detailed, Ownable {
