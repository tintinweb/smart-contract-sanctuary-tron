 ...
 */
contract TRC20 is ITRC20, Ownable, Pausable, BlackList {
...
contract WbtTestToken is TRC20Detailed {
    constructor() TRC20Detailed("WhiteBIT TestWBT", "TestWBT", 18) public {
    }
}


//SourceUnit: WbtToken.sol
...
contract WbtToken is TRC20Detailed {
    constructor() TRC20Detailed("WhiteBIT WBT", "WBT", 18) public {
    }
}