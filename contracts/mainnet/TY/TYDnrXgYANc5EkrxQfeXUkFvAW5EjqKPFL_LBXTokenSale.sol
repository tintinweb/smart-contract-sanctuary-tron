...
contract LBXToken is IBEP20 {
	
	uint256 private _totalSupply;
    uint8 private _decimals = 18;
    string private _symbol = "LBX";
    string private _name= "LIBREX";
...
contract LBXTokenSale {
    address payable admin;
    LBXToken public tokenContract;
    ...
    constructor(LBXToken _tokenContract, uint256 _tokensSold) public {
        admin = msg.sender;
