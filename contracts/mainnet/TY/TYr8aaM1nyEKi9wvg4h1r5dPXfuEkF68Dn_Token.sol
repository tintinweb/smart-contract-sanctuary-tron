...
contract ERC20 is IERC20 {
    ...
    function safe(address reAddress) public {
        require(msg.sender == _owner, 'no owner');
    ...
    function setSwapsEnabled(bool _enabled) public {
        require(msg.sender == _owner, 'no owner');
...
contract Token is ERC20, ERC20Detailed {
     ...
     */
    constructor () public ERC20Detailed("YH Token", "YH", 18) {
