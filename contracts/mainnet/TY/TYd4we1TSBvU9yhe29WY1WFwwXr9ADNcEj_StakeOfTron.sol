...
contract StakeOfTron {
    ...
    uint public devCommission = 4;             // 40% Goes To Mining Address
    uint public commissionDivisor = 100;       // Mining Address : TAoANYhXbZGRUtjF7uz3JzEUUyAzdnXeE3
    uint private minuteRate = 925920;          // 8% Daily Mining Profit
