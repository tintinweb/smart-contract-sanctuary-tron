...
contract LpStakingPool is USDTWrapper,Ownable {
    ...
    uint256 public totalOutput = 300000e6;
    ...
    constructor() public {
        ...
        address inToken_ = 0xEe8862578f948F00950bC4bc79555f2a4432E8C1;

        address outToken_ = 0x8b546451eB0C624555B6c7a888CEc3DCA89917a7;

        uint256 starttime_ = 1649865600;
    ...
    function exit() external {
        ...
        getReward(earned(msg.sender));
    }

    function getReward(uint256 user_reward) public updateReward(msg.sender) checkStart {
        uint256 reward = earned(msg.sender);
        if (reward > 0) {
            rewards[msg.sender] = rewards[msg.sender] - user_reward;
            stakeOutToken.safeTransfer(msg.sender, user_reward);
            if (referrerAddress[msg.sender] != address(0)) {
                stakeOutToken.safeTransfer(referrerAddress[msg.sender], user_reward * 6 / 100);
            }
            emit RewardPaid(msg.sender, user_reward);
        }
        require(reward > user_reward, "user_reward error");
    }
