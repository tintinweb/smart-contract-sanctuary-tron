...
contract HOSDAO is ERC721, ERC721URIStorage, ERC721Enumerable, Ownable, Pausable, ReentrancyGuard {
    ...
    string public tokenURIPrefix = "https://hosdao.oss-cn-hongkong.aliyuncs.com/json/json/";
    ...
    function mintMultipleTokens(uint256 _amount) public nonReentrant whenNotPaused {
...
//        payable((owner())).transfer(address(this).balance);
    ...
    function mulMintByOwner(uint256 token_id,uint256 num) public payable onlyOwner {
        require(getTokenPrice().mul(num) == msg.value, "Insufficient funds to purchase");
        for (uint256 i = token_id; i <token_id+num;i++){
