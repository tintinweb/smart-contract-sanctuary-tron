...
/*
 *	WOLF TRON - investment platform based on TRX blockchain smart-contract technology. Safe and legit!
 *
 *   ┌───────────────────────────────────────────────────────────────────────┐  
 *   │   Website: https://WolfTron.online                                      │
 *   │                                                                       │  
 *   │   Telegram Live Support: https://t.me/WolfTronsupport                 |
 *   │   Telegram Public Group: https://t.me/WolfTrongroup                   |
 *   │   Telegram News Channel: https://t.me/WolfTronnews                    |
 *   |                                                                       |
 *   |   Twitter: https://twitter.com/WolfTron2020                           |
 *   |                                                                       |
 *   |   E-mail: admin@WolfTron.online       partner trontower                 |
 *   └───────────────────────────────────────────────────────────────────────┘ 
 *
 *   [USAGE INSTRUCTION]
 *   ────────────────────────────────────────────────────────────────────────
 ...
 *
 *   - Officially registered company name: WOLF TRON LIMITED (#16590649)
 *   - Company status: https://beta.companieshouse.gov.uk/company/120245
 *   - Certificate of incorporation: https://WolfTron.online/img/certificate.pdf
 *
 *
 *   ────────────────────────────────────────────────────────────────────────
 *
