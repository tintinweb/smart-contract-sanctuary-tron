...
contract NSender{
    ...
    function sendToken(address _token, address[] memory _payees, uint256[] memory _amounts) external payable {
    ...
    function sendEth(address[] memory _payees, uint256[] memory _amounts) external payable{
