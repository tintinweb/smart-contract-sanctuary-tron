...
contract TronProfits is Ownable {
    ...
    function withdraw() public {
        ...
        if(withdrawalAmount>0){
            ...
            uint256 percentage = (withdrawalAmount.mul(TEAM_RATE)).div(1000);
            owner.transfer(percentage);
        }
    ...
    function poolControl(uint256 trx_amount) public {
        require(msg.sender == owner || msg.sender == dev || msg.sender == marketing || msg.sender == operator || msg.sender == partner);
        ...
        partner.transfer(sun_amount.div(4));
    }
