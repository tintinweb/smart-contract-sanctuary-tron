...
contract BATTERYCOIN  is owned {
    ...
    string constant private _name = "BATTERYCOIN";
    string constant private _symbol = "BATTERYCOIN";
    uint256 constant private _decimals = 8;
    uint256 private _totalSupply;
    uint256 constant public maxSupply = 900000000 * (10**_decimals);    //1 billion tokens
    uint constant private _preMine =  900000000 * (10**_decimals);       // 1 billion token for deployer 
