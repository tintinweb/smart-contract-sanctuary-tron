...
contract Sellix {
    ...
    function balanceToken(ITRC20 tokenAddr) public view returns (uint256) {
    ...
    function multiPayoutToken(
        ...
        require(
            total <= tokenAddr.balanceOf(address(this)),
    ...
    function multiPayoutTrx(
        ...
        uint256 requiredAmount = total.add(trxSendFee);
        require(
