//SourceUnit: PudgyPenguins-tron.sol
...
contract TronPudgyPenguins is ERC721Enumerable, Ownable, ERC721Burnable, ERC721Pausable {
    ...
    constructor(string memory baseURI) ERC721("TronPudgyPenguins", "PPG") {
        setBaseURI(baseURI);
        pause(true);
    }
