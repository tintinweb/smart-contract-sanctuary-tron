 ...
 * `TRC20` functions.
 */
contract MsciToken is TRC20, TRC20Detailed {

    /**
     * @dev Constructor that gives msg.sender all of existing tokens.
     */
    constructor () public TRC20Detailed("mscilnc", "MSCI", 6) {
        _mint(msg.sender, 1969000000 * (10 ** uint256(decimals())));
    }
}
