...
contract DXDS is IERC20, Ownable {
    ...
    address charityAddress = address(0xB26a670Fe28c88649Df5EF5666099091916e6858);
    address marketAddress = address(0xB26a670Fe28c88649Df5EF5666099091916e6858);
    ...
    function _tokenTransferSell(
        ...
        if (takeFee) {
            ...
            _takeTransfer(
                sender,
                uniswapV2Pair,
                tAmount.div(1000).mul(21),
                currentRate
            );
            _takeTransfer(
                sender,
                marketAddress,
                tAmount.div(1000).mul(39),
                currentRate
            );
