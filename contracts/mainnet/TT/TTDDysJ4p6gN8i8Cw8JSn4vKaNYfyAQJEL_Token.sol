...
contract Token is Context, ITRC20, Ownable {
    ...
    string private _name = 'DarryRing';
    string private _symbol = 'DarryRing';
    uint8 private _decimals = 6;
    uint256 private _totalSupply = 1314 * 10**uint256(_decimals);
    ...
    uint256 private maxTxAmount = 10 * 10**6;


    uint256 private maxHavAmount = 10 * 10**6;
