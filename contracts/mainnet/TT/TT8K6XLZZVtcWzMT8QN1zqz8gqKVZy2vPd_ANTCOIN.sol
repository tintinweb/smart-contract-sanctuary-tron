...
contract ANTCOIN  is owned {
    ...
    string constant private _name = "ANTCOIN";
    string constant private _symbol = "ANTC";
    uint256 constant private _decimals = 8;
    uint256 private _totalSupply;
    uint256 constant public maxSupply = 210000000 * (10**_decimals);    //4 cr. tokens
    uint constant private _preMine =  210000000 * (10**_decimals);       // 4 cr. token for deployer 
