...
contract _TSSDDOLLAR is ERC20, ERC20Detailed, ERC20Burnable {
    constructor() ERC20Detailed('TSSD_Dollar', 'TSSD', 18) public {
...
contract TSSDDOLLAR  is Ownable,_TSSDDOLLAR {
      using SafeMath for uint256;
