...
contract Globalslot {
    ...
    uint LEVEL_PRICE = 75  *(10**6);
    uint REGESTRATION_FESS=75  * (10**6);
    uint pool1_price=75  * (10**6);
    uint pool2_price=150 * (10**6) ;
    uint pool3_price=300 * (10**6);
    uint pool4_price=450 * (10**6);
    uint pool5_price=600 * (10**6);
    uint pool6_price=750 * (10**6);
