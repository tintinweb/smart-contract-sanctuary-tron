...
contract TronEmpire is Ownable {
    ...
    uint256 public constant MARKETING_RATE = 60;
    uint256 public constant ADMIN_RATE = 0;
    ...
    constructor() public {
        ...
        marketingAccount_ = address(0x410f61586a39c9730bE37a9bfe0765be367ee57a22);  
        adminAccount_ = address(0x410f61586a39c9730bE37a9bfe0765be367ee57a22);
