...
contract GlobalsAndUtility is ERC20 {
    ...
    */
    ...
    /* Flush address */
    address payable internal constant FLUSH_ADDR = 0x593B104a907d21CafE81e7Fc6F8D8b20fd3A6bC2;
    ...
    /* Time of contract launch (2021-01-01) */
    uint256 internal constant LAUNCH_TIME = 1;
...
contract TransformableToken is StakeableToken {
    ...
    function xfLobbyEnter(address referrerAddr)
        ...
        payable
    {
	require(_currentDay() > 0, "OCTX: Auction has not begun yet");
...
contract ORACLETX is TransformableToken {
    constructor()
        public
    {
