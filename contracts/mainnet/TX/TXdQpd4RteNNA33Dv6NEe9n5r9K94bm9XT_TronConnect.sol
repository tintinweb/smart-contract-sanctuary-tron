 ...
 *
 *   ┌───────────────────────────────────────────────────────────────────────┐
 *   │   Website: https://tronconnect.com                                    │
 *   │                                                                       │
 *   │   Telegram Public Group: @tronconnect_ENG                             |
 *   │   Telegram News Channel: @tronconnect_news                            |
 *   |                                                                       |
 *   |   E-mail: support@tronconnect.com                                     |
 *   └───────────────────────────────────────────────────────────────────────┘
 *
 *   [USAGE INSTRUCTION]
 *
 ...
 *   - Certificate of incorporation: https://tronconnect.com/certificate.pdf
 *
