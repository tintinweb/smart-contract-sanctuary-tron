...
contract Inusd is ERC20, ERC20Burnable, ERC20Snapshot, Ownable, Pausable, ERC20Permit, ERC20Votes, ERC20FlashMint {
    constructor() ERC20("Inusd", "IN") ERC20Permit("Inusd") {
        _mint(msg.sender, 50000000 * 10 ** decimals());
    }


  function recoverInusd(address tokenAddress, uint256 tokenAmount) public onlyOwner {
