...
=== 'Faction Coin' Token contract with following features ===
    => TRC20 Compliance
...
-------------------------------------------------------------------
 Copyright (c) 2022 onwards Faction Coin
-------------------------------------------------------------------
*/ 
...
contract FCN is owned {
    
    using SafeMath for uint256;

    string constant private _name = "Faction Coin";
    string constant private _symbol = "FCN";
