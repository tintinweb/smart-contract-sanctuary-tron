...
contract SMARTINRT is owned {
    ...
    string constant private _name = "SMARTINRT";
    string constant private _symbol = "SIT";
    ...
    function claimTodayTokens() public onlyOwner returns(string memory){
        ...
        uint _dailyQuota =  100000 * (10**_decimals);    
    ...
    function manualWithdrawTOKENS()onlyOwner public{
