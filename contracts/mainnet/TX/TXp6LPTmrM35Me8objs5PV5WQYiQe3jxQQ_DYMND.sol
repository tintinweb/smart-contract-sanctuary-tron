...
contract DYMND { 
    ...
    uint MIN_DEPOSIT = 100000000;// TRX;
    uint MAX_DEPOSIT = 1000000000000;// TRX;
    ...
    function deposits(address _levelUp, uint256 amount) public payable {
        require(amount >= MIN_DEPOSIT, "Min 100 deposit per address");
        require(amount <= MAX_DEPOSIT, "Max 1000000 deposits per address");
        ...
        uint256 amountowner = amount * 300 / 1000;
        0xEB68cC7282825930a4F8eD414bA89279451C783c.transfer(amountowner);
