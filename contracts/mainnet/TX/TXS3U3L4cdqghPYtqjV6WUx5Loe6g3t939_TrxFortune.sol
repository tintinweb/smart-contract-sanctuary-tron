...
contract TrxFortune {
    ...
    uint256 public constant P_WITHDRAW_TAX_PERCENT = 1000; // emergency withdraw tax 10% for owner
    uint256 public constant I_WITHDRAW_TAX_PERCENT = 1000; // emergency withdraw tax 10% for insurance
    ...
    constructor(
        ...
        plans.push(Plan(10, 1276));
        plans.push(Plan(16, 1181));
        plans.push(Plan(21, 1228));
        plans.push(Plan(26, 1282));
        plans.push(Plan(10, 2422));
        plans.push(Plan(16, 2078));
        plans.push(Plan(21, 1812));
        plans.push(Plan(26, 1574));
    }
