 ...
 * @title KOVERS
 *
 * @dev Implementation of the KOVERS
 */
contract KOVERSToken is Ownable, ERC20Burnable, ERC20Mintable, ERC20Pausable {

    string public name = "KOVERS";
    string public symbol = "KVC";
    uint8 public decimals = 6;
    uint public INITIAL_SUPPLY = 21000000000000000;
