...
contract Token is Context, IERC20, Ownable {
    ...
    uint256 private  _tTotal = 9990000 * 10**6;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    
    uint256 private _tBurnTotal;

    string private _name = 'WWB Token';
    string private _symbol = 'WWB';
    uint8 private _decimals = 6;
    
    address private _burnPool = 0x000000000000000000000000000000000000dEaD;
    
    address private fundAddress = address(0x4118F602BBA5B341FE95985E73FA5469C39834BEBC);
    ...
    uint256 private _previousFundFee = _fundFee;
     uint256 public  MAX_STOP_FEE_TOTAL = 99000 * 10**uint256(_decimals);
