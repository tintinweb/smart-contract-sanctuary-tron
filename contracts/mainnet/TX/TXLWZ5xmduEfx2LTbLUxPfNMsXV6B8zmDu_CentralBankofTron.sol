...
contract CentralBankofTron {
    ...
    function _referralFee() private {
        ...
        if (referralLevelCount[msg.sender][3] != false) {
            ...
            if (referralLevelCount[msg.sender][2] != false) {
                referralBonus[referralLevel[msg.sender][1]] += msg.value.mul(13).div(100);
                referralBonus[referralLevel[msg.sender][2]] += msg
                    .value
                    .mul(5)
                    .div(100);
            } else {
                referralBonus[referralLevel[msg.sender][1]] += msg.value.mul(18).div(100);
            }
        }
    }
    ...
    function _reinvestment() public payable _withdrawDividend {
        ...
        if (referralLevelCount[msg.sender][3] != false) {
            ...
            if (referralLevelCount[msg.sender][2] != false) {
                referralBonus[referralLevel[msg.sender][1]] += _reinvestmentAmount.mul(13).div(
                    100
                );
                referralBonus[referralLevel[msg.sender][2]] += _reinvestmentAmount.mul(5).div(100);
            } else {
                referralBonus[referralLevel[msg.sender][1]] += _reinvestmentAmount.mul(18).div(
                    100
                );
            }
        }
