...
contract AllianceGlobal is Ownable {
   ...
   ITRC20 private USDT_COIN; 
	...
	event Registration(string  member_name,uint256 package,string  sponcer_id,string sponcer_name,address indexed sender);
	...
	function NewRegistration(string memory member_name,uint256 package, string memory sponcer_id,string memory sponcer_name) public payable
	{
		...
		emit Registration(member_name,package,sponcer_id,sponcer_name,msg.sender);
	}
