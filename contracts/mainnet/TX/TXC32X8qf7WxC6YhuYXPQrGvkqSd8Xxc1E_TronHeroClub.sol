...
*
* https://tronhero.club
* (only for tronhero.club Community)
* Crowdfunding And Investment Program: 25% Daily ROI for 10 Days.
* Referral Program
* 1st Level = 10%
* 2nd Level = 5%
* 3rd Level = 3%
...
contract TronHeroClub is Ownable {
    ...
    uint256 public constant PLAN_INTEREST = 250;            // 30% Daily Roi
    uint256 public constant PLAN_TERM = 10 days;             // 7 Days
