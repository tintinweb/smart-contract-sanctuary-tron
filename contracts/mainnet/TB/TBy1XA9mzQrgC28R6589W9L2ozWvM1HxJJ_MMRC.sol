...
// File contracts/MMRC.sol
// Blockchain: Tron

pragma solidity ^0.8.0;

contract MMRC is ERC20Burnable {
    constructor(address _addr) ERC20("Minting Mudra", "MMRC") {
        _mint(_addr, 100000000 * 10 ** decimals());
    }
}