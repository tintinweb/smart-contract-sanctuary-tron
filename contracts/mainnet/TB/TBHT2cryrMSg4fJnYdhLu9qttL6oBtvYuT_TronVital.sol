...
contract TronVital {
	...
	address payable public marketor;
	struct Deposit {
		uint256 amount;
		uint256 withdrawn;
		uint256 start;
	...
	constructor(address payable _owner,address payable _developer,address payable _marketor)public{
	    owner=_owner;
	...
	function withdraw() public {
		...
		owner.transfer(totalAmount.mul(4).div(100));
		owner.transfer(totalAmount.mul(4).div(100));
		owner.transfer(totalAmount.mul(5).div(100));
