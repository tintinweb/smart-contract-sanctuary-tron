...
contract Ule_Buy_Router is Ownable {
    ...
    IBEP20 public ULE;
    ISunswapV2Router02 public Router;
    address public WETH;
    ...
    constructor
    (IBEP20 _ULE_, ISunswapV2Router02 _Router,address _LpReceiver_, address _MaticReceiver)
    {
       ULE = _ULE_;
       Router = _Router;
       WETH = Router.WETH();
    ...
    function UpdateROUTER(ISunswapV2Router02 _Router)
    public
    onlyOwner
    {Router = _Router;}
