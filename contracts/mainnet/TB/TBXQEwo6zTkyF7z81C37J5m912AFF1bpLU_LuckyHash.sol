...
contract LuckyHash is Context, Ownable {
    ...
    function takeBetAmount(uint256 amount) internal {
        require(amount >= 10*10**6 && amount <= 10000*10**6, "E");
...
// testnet  
// honey  TJNF6Vwz3AWk9qZc6cZ8vMhKeG1nCVjE44
// luckyhash TG1QbXDrL1m4aCyxJ3WSUv6GLtDd5ngdfa 

// mainnet 
// luckyhash TBXQEwo6zTkyF7z81C37J5m912AFF1bpLU