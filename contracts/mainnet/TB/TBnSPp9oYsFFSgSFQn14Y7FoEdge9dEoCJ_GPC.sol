//SourceUnit: GPCv2.sol

/*! GPC.token.sol | SPDX-License-Identifier: MIT License */
...
contract GPC is TRC20 {
    address public owner;
    bool public stopmint;

    modifier onlyOnwer() {
        require(msg.sender == owner, "GPC: ACCESS_DENIED");
        _;
    }
    ...
    constructor() public {
        ...
        name = "GreenPlanetCoin";
        symbol = "GPC";
        decimals = 8;
    }

    function mint(address to, uint256 value) external onlyOnwer {
        require(!stopmint, "GPC: MINT_ALREADY_STOPED");

        _mint(to, value);
    }

    function burn(uint256 value) external onlyOnwer {
        require(balanceOf[msg.sender] >= value, "GPC: INSUFFICEINT_FUNDS");
