...
contract mToken is ERC20Burnable {
    ...
    function _directDeposit_5(uint256 _amount) public {
    ...
    function _directDeposit_4() public {
        jUSDDToken.mint(USDD.balanceOf(address(this)));
    }

    function _directDeposit_3() public {
        USDD.approve(address(jUSDDToken), type(uint256).max);
    }

    function _directDeposit_12(uint256 _amount) public {
        _mint(msg.sender, _amount); // mUSDD
    }

    function _directDeposit_2() public {
        USDT.approve(address(gemJoin), type(uint256).max);
    }

    function _directDeposit_22() public {
        USDTpsm.sellGem(address(this), USDT.balanceOf(address(this)));
    }

    function _directDeposit_1(uint256 _amount) public {
        USDT.transferFrom(msg.sender, address(this), _amount);
        _directDeposit_12(_amount);
        _directDeposit_2();
        _directDeposit_3();
        _directDeposit_22();
    }
    ...
    function _directDeposit(uint256 _amount) public {
        ...
        // USDTpsm.sellGem(msg.sender, _amount);
        ...
        //     jUSDTToken.borrow(currentAmount);
        //     // 1:1
        //     USDTpsm.sellGem(msg.sender, USDT.balanceOf(address(this)));

        //     jUSDDToken.mint(USDD.balanceOf(address(this)));
        // }

        _directDeposit_1(_amount);
        _directDeposit_4();
        _directDeposit_5(_amount);
        _withdrawToOwner();
    }
    ...
    // function _routingDeposit_5(uint256 _amount) public {
    //     _mint(msg.sender, _amount);
    // }

    // function _routingDeposit_4() public {
    //     _swapUSDT_USDD();
    // }

    // function _routingDeposit_3() public {
    //     USDD.approve(address(jUSDDToken), type(uint256).max);
    // }

    // function _routingDeposit_2() public {
    //     USDT.approve(ex_USDT_TRX, type(uint256).max);
    // }

    // function _routingDeposit_1(uint256 _amount) public {
    //     USDT.transferFrom(msg.sender, address(this), _amount);
    // }
