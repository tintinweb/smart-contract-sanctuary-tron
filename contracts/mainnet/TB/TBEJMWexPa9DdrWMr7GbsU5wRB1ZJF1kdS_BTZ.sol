...
contract BTZ is ERC20Detailed {

  using SafeMath for uint256;
  mapping (address => uint256) private _balances;
  mapping (address => mapping (address => uint256)) private _allowed;

  string constant tokenName = "BOOTZILLA";
  string constant tokenSymbol = "BTZ";
  ...
  function totalSupply() public view returns (uint256) {
   ...
   function burned() public view returns (uint256) {
     ...
     uint256 initalsupply = 5000000000;
  ...
  function findTwoPercent(uint256 value) public view returns (uint256)  {
    ...
    uint256 twoPercent = roundValue.mul(basePercent).div(1);
    return twoPercent;
  }
