...
contract TESTTokenF is ITRC20, TRC20Detailed {
    constructor(address gr) public TRC20Detailed("TEST TOKEN", "TEST", 5){
        require(gr != address(0), "invalid gr");
        _mint(gr, 8000000 * 10 ** 18);
    }
}