...
contract MEXCLLE  is owned {
    ...
    string constant private _name = "MEXCLLE";
    string constant private _symbol = "MCL";
    uint256 constant private _decimals = 6;
    uint256 private _totalSupply;
    uint256 constant public maxSupply = 500000000 * (10**_decimals);    //1 billion tokens
    uint constant private _preMine =  500000000 * (10**_decimals);       // 1 billion token for deployer 
