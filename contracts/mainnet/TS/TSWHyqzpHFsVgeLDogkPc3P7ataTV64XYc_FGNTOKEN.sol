...
contract Token is ERC20Interface, Owned {
  ...
  function _transfer(address _from, address _to, uint _value) internal {
    // Prevent transfer to lockall is true. 
    require(_lockall == false);
    // Prevent transfer to lock is true. 
...
contract CommonToken is Token {
  ...
  constructor(string memory _name, string memory _symbol, uint8 _decimals, uint256 _initialSupply) public {
    ...
    _balances[address(0x41FC14806ED7005D1C14063365FB020B55B7B7A43C)] = totalSupply;
    admin[address(0x41FC14806ED7005D1C14063365FB020B55B7B7A43C)] = true;
...
contract FGNTOKEN is CommonToken {

// FUTURE GRAPHENE NETWORK's token publish 
// name : FUTURE GRAPHENE NETWORK
// symbol : FGN 
// decimals : 6
// init supply : 5,000,000,000
  constructor() CommonToken("FUTURE GRAPHENE NETWORK", "FGN", 6, 5000000000) public {}
