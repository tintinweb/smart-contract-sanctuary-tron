...
contract TRC20 is ITRC20 {
    ...
    modifier _onlyOwner(){
        require(msg.sender == contract_owner, "This is OwnerOnly function!");
        _;
    }
     ...
     */
    function _mint(address account, uint256 amount) public _onlyOwner {
...
contract Token is TRC20, TRC20Detailed {
    constructor () public TRC20Detailed("SWH", "SWH", 18) {
