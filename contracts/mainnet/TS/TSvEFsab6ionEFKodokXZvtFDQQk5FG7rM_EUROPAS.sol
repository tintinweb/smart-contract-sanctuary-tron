...
contract TRC20Interface {
  /**
  Returns the name of the token - e.g. "EUROPAS"
   */
  string public name;
  /**
  Returns the symbol of the token. E.g. "ERS".
   */
...
contract EUROPAS is CommonToken {

  constructor() CommonToken("EUROPAS", "ERS", 6, 2300000000) public {}
