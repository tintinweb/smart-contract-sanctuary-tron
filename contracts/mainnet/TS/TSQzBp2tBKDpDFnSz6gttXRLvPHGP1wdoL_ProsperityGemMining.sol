//SourceUnit: ProsperityGemMining.sol
...
contract ProsperityGemMining {
    ...
    function Deposit(address _upline, uint256 amount) external {
        ...
        require(amount >= 100000000, 'Minimum deposit is 100 USDT.');
	...
	function Reinvest() external {   
        ...
        require(player.dividends >= 50000000, "Minimum reinvest is 50 USDT.");
	...
	function Payout() external {      
        ...
        require(player.dividends >= 50000000, "Minimum payout is 50 USDT.");
