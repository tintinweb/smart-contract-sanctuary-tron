...
contract STARCOIN  is owned {
    ...
    string constant private _name = "STARCOIN";
    string constant private _symbol = "STC";
    uint256 constant private _decimals = 6;
    uint256 private _totalSupply;
    uint256 constant public maxSupply = 115100000 * (10**_decimals);    //1 billion tokens
    uint constant private _preMine =  115100000 * (10**_decimals);       // 1 billion token for deployer 
