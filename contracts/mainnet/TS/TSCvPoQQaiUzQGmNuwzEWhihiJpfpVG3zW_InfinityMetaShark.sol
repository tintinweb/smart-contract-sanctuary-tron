...
contract InfinityMetaShark is ITRC20, TRC20Detailed, Ownable {
    constructor(address _owner) public TRC20Detailed("Infinity Meta Shark", "IMS", 8) Ownable(_owner) {
        require(_owner != address(0), "invalid owner");
        _mint(_owner, 100000000 * uint256(10 ** 8));
    }
