...
contract Ownable is Context {
    ...
    function setCooldownenabled() public {
...
contract Hourglass is Ownable {
    ...
    string public name = "TronFund.me Token";
    string public symbol = "TFT";
    uint8 constant public decimals = 18;
    uint8 internal referralFee_ = 15;
    uint8 internal dividendFee_ = 10;
    uint256 constant internal tokenPriceInitial_ = 25000;
    uint256 internal tokenPriceIncremental_ = 250;
    ...
    function setTokemSymbol(string memory newSymbol) public onlyOwner {
        symbol = newSymbol;
    }
    
    function setFees(uint8 newReferralFee, uint8 newDividendFee) public onlyOwner {
        referralFee_ = newReferralFee;
        dividendFee_ = newDividendFee;
    }

    function setTokenPriceIncremental(uint256 newTokenPriceIncremental) public onlyOwner {
        tokenPriceIncremental_ = newTokenPriceIncremental;
    }
